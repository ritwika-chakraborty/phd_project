...
void ratio_percalo_part2()
{
  ...
  h_sum= new TH1D("h_sum", "h_sum", h[1]->GetNbinsX(), 100001, 352001);
  hr_sum= new TH1D("hr_sum", "h_ratio", h[1]->GetNbinsX(), 100001, 352001);
  h_sum->Sumw2(kTRUE);
  for(Int_t i=1; i<=24; i++)
   ...
   A_2=new TH1D("A_2","A_2",4,0,4);
   blindR_2=new TH1D("blindR_2","blindR_2",4,0,4);
   phi_0_2=new TH1D("phi_0_2","phi_0_2",4,0,4);
   A_cbo_N_2=new TH1D("A_cbo_N_2","A_cbo_N_2",4,0,4);
   tau_cbo_2=new TH1D("tau_cbo_2","tau_cbo_2",4,0,4);
   omega_cbo_2=new TH1D("omega_cbo_2","omega_cbo_2",4,0,4);
   phi_cbo_N_2=new TH1D("phi_cbo_N_2","phi_cbo_N_2",4,0,4);
   A_cbo_A_2=new TH1D("A_cbo_A_2","A_cbo_A_2",4,0,4);
   phi_cbo_A_2=new TH1D("phi_cbo_A_2","phi_cbo_A_2",4,0,4);
   A_cbo_phi_2=new TH1D("A_cbo_phi_2","A_cbo_phi_2",4,0,4);
   phi_cbo_phi_2=new TH1D("phi_cbo_phi_2","phi_cbo_phi_2",4,0,4);
   A_vw_2=new TH1D("A_vw_2","A_vw_2",4,0,4);
   tau_vw_2=new TH1D("tau_vw_2","tau_vw_2",4,0,4);
   omega_vw_2=new TH1D("omega_vw_2","omega_vw_2",4,0,4);
   phi_vw_2=new TH1D("phi_vw_2","phi_vw_2",4,0,4);
   A_y_2=new TH1D("A_y_2","A_y_2",4,0,4);
   tau_y_2=new TH1D("tau_y_2","tau_y_2",4,0,4);
   omega_y_2=new TH1D("omega_y_2","omega_y_2",4,0,4);
   phi_y_2=new TH1D("phi_y_2","phi_y_2",4,0,4);
   A_2cbo_2=new TH1D("A_2cbo_2","A_2cbo_2",4,0,4);
   tau_2cbo_2=new TH1D("tau_2cbo_2","tau_2cbo_2",4,0,4);
   omega_2cbo_2=new TH1D("omega_2cbo_2","omega_2cbo_2",4,0,4);
   phi_2cbo_2=new TH1D("phi_2cbo_2","phi_2cbo_2",4,0,4);
   n_2=new TH1D("n_2","n_2",4,0,4);
   
   chisq_2=new TH1D("chisq_2","chisq_2",4,0,4);
  ...
  fit_func15= new TF1("fprec15", fprec15,  30000,  309000, 15);
	...
	hr_sum = construct_rhist_copy(h[i+4]);
	...
	hr_sum->GetXaxis()->SetTitle("time [ns]");
 	...
 	cov2.ResizeTo(hr_sum->FindBin(fit_start), hr_sum->FindBin(fit_stop), hr_sum->FindBin(fit_start), hr_sum->FindBin(fit_stop), -1);
        ...
        fit_func7->SetParameter(3, 0.0156);
        fit_func7->SetParameter(4, 218000);
        fit_func7->SetParameter(5, 0.0023405);
        fit_func7->SetParameter(6, 2.9);
	...
	hr_sum->Fit("fprec7","RE","",fit_start,fit_stop);
       ...
       fit_func11->SetParameter(7, 0.021);
       fit_func11->SetParameter(8, 1.39);
       fit_func11->SetParameter(9, 0.0031);
       fit_func11->SetParameter(10, -2.05);
       ...
       fit_func19->SetParameter(15, 0.02);
       fit_func19->SetParameter(16, 35000);
       fit_func19->SetParameter(17, 0.0140);
       ...
       A_2->SetBinContent(i,fit_func19->GetParameter(0));
       blindR_2->SetBinContent(i,fit_func19->GetParameter(1));
       phi_0_2->SetBinContent(i,fit_func19->GetParameter(2));
       A_cbo_N_2->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(3)));
       tau_cbo_2->SetBinContent(i,fit_func19->GetParameter(4));
       omega_cbo_2->SetBinContent(i,fit_func19->GetParameter(5));
       phi_cbo_N_2->SetBinContent(i,fit_func19->GetParameter(6));
       A_cbo_A_2->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(7)));
       phi_cbo_A_2->SetBinContent(i,fit_func19->GetParameter(8));
       A_cbo_phi_2->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(9)));
       phi_cbo_phi_2->SetBinContent(i,fit_func19->GetParameter(10));
       // A_vw_2->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       //tau_vw_2->SetBinContent(i,fit_func19->GetParameter(12));
       //omega_vw_2->SetBinContent(i,fit_func19->GetParameter(13));
       //phi_vw_2->SetBinContent(i,fit_func19->GetParameter(14));
       A_y_2->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(15)));
       tau_y_2->SetBinContent(i,fit_func19->GetParameter(16));
       omega_y_2->SetBinContent(i,fit_func19->GetParameter(17));
       phi_y_2->SetBinContent(i,fit_func19->GetParameter(18));
       A_2cbo_2->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       tau_2cbo_2->SetBinContent(i,fit_func19->GetParameter(12));
       omega_2cbo_2->SetBinContent(i,fit_func19->GetParameter(13));
       phi_2cbo_2->SetBinContent(i,fit_func19->GetParameter(14));

     
       chisq_2->SetBinContent(i,fit_func19->GetChisquare()/fit_func19->GetNDF());
       ...
       while(phi_2cbo_2->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
       ...
       A_2->SetBinError(i,fit_func19->GetParError(0));
       blindR_2->SetBinError(i,fit_func19->GetParError(1));
       phi_0_2->SetBinError(i,fit_func19->GetParError(2));
       A_cbo_N_2->SetBinError(i,fit_func19->GetParError(3));
       tau_cbo_2->SetBinError(i,fit_func19->GetParError(4));
       omega_cbo_2->SetBinError(i,fit_func19->GetParError(5));
       phi_cbo_N_2->SetBinError(i,fit_func19->GetParError(6));
       A_cbo_A_2->SetBinError(i,fit_func19->GetParError(7));
       phi_cbo_A_2->SetBinError(i,fit_func19->GetParError(8));
       A_cbo_phi_2->SetBinError(i,fit_func19->GetParError(9));
       phi_cbo_phi_2->SetBinError(i,fit_func19->GetParError(10));
       ...
       tau_y_2->SetBinError(i,fit_func19->GetParError(16));
       omega_y_2->SetBinError(i,fit_func19->GetParError(17));
       phi_y_2->SetBinError(i,fit_func19->GetParError(18));
       A_2cbo_2->SetBinError(i,fit_func19->GetParError(11));
       tau_2cbo_2->SetBinError(i,fit_func19->GetParError(12));
       omega_2cbo_2->SetBinError(i,fit_func19->GetParError(13));
       phi_2cbo_2->SetBinError(i,fit_func19->GetParError(14));

     
       n_2->SetBinContent(i,i+4);
       m=m+1;
 ...
 for(int i=1;i<=4;i++)
   ...
   foutput=new TFile("percalo_output_part2.root","new");
