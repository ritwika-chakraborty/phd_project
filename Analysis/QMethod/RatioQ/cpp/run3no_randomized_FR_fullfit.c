...
TF1 *fit_func3, *fit_func7, *fit_func11, *fit_func15, *fit_func19, *fit_func23, *fit_func24, *fit_func27,*fit_func29,*fit_func30;
...
Double_t fprec27(Double_t *x, Double_t *par)
{
    ...
    double Tau_new = par[24];

    double omega_new = par[25];

    double phi_new = par[26];
    ...
    double Nnew =  (1 + A_new * exp(-time/Tau_new) * (cos(omega_new*time - phi_new)));

    double Nnewf =  (1 + A_new * exp(-(time + T_a/2)/Tau_new) * (cos(omega_new*(time + T_a/2) - phi_new)));

    double Nnewb =  (1 + A_new * exp(-(time - T_a/2)/Tau_new) * (cos(omega_new*(time - T_a/2) - phi_new)));
...
Double_t fprec29(Double_t *x, Double_t *par)
{
    ...
    double NVD =  (1 + A_VD * exp (-time/Tau_VD));

    double NVDf =  (1 + A_VD * exp (-(time + T_a/2)/Tau_VD));

    double NVDb =  (1 + A_VD * exp (-(time - T_a/2)/Tau_VD));
...
Double_t fprec30(Double_t *x, Double_t *par)
{
    ...
    double Nloss =  ( 1 - lost_muon_amp * hlm->GetBinContent(hlm->GetXaxis()->FindBin( time )));

    double Nlossf =  ( 1 - lost_muon_amp * hlm->GetBinContent(hlm->GetXaxis()->FindBin( (time + T_a/2) )));

    double Nlossb =  ( 1 - lost_muon_amp * hlm->GetBinContent(hlm->GetXaxis()->FindBin( (time - T_a/2) )));
...
void run3no_randomized_FR_fullfit()
{

  _file[0]=TFile::Open(muonloss_rootfile);
  _file[0]->GetObject("Run3b",dir[0]);
    ...
    if(useFR)
   {
	...
	hr4[i]->Scale(0.5);
     ...
     fit_func23->SetNpx(1000000);
       ...
       fit_func27= new TF1("fprec27", fprec27,  30000,  309000, 27);
     fit_func27->SetParNames("A", "Blind R", "Phi");
     fit_func27->SetParName(3,"A_cbo_N");
     fit_func27->SetParName(4,"Tau_cbo");
     fit_func27->SetParName(5,"omega_cbo");
     fit_func27->SetParName(6,"phi_cbo_N");
     fit_func27->SetParName(7,"A_cbo_A");
     fit_func27->SetParName(8,"phi_cbo_A");
     fit_func27->SetParName(9,"A_cbo_phi");
     fit_func27->SetParName(10,"phi_cbo_phi");
     fit_func27->SetParName(11,"A_2cbo");
     fit_func27->SetParName(12,"Tau_2cbo");
     fit_func27->SetParName(13,"omega_2cbo");
     fit_func27->SetParName(14,"phi_2cbo");
     fit_func27->SetParName(15,"A_y");
     fit_func27->SetParName(16,"Tau_y");
     fit_func27->SetParName(17,"omega_y");
     fit_func27->SetParName(18,"phi_y");
     fit_func27->SetParName(19,"A_vw");
     fit_func27->SetParName(20,"Tau_vw");
     fit_func27->SetParName(21,"omega_vw");
     fit_func27->SetParName(22,"phi_vw");
     fit_func27->SetParName(23,"A_new");
     fit_func27->SetParName(24,"Tau_new");
     fit_func27->SetParName(25,"omega_new");
     fit_func27->SetParName(26,"phi_new");
     fit_func27->SetNpx(1000000);

     fit_func29= new TF1("fprec29", fprec29,  30000,  309000, 29);
     fit_func29->SetParNames("A", "Blind R", "Phi");
     fit_func29->SetParName(3,"A_cbo_N");
     fit_func29->SetParName(4,"Tau_cbo");
     fit_func29->SetParName(5,"omega_cbo");
     fit_func29->SetParName(6,"phi_cbo_N");
     fit_func29->SetParName(7,"A_cbo_A");
     fit_func29->SetParName(8,"phi_cbo_A");
     fit_func29->SetParName(9,"A_cbo_phi");
     fit_func29->SetParName(10,"phi_cbo_phi");
     fit_func29->SetParName(11,"A_2cbo");
     fit_func29->SetParName(12,"Tau_2cbo");
     fit_func29->SetParName(13,"omega_2cbo");
     fit_func29->SetParName(14,"phi_2cbo");
     fit_func29->SetParName(15,"A_y");
     fit_func29->SetParName(16,"Tau_y");
     fit_func29->SetParName(17,"omega_y");
     fit_func29->SetParName(18,"phi_y");
     fit_func29->SetParName(19,"A_vw");
     fit_func29->SetParName(20,"Tau_vw");
     fit_func29->SetParName(21,"omega_vw");
     fit_func29->SetParName(22,"phi_vw");
     fit_func29->SetParName(23,"A_new");
     fit_func29->SetParName(24,"Tau_new");
     fit_func29->SetParName(25,"omega_new");
     fit_func29->SetParName(26,"phi_new");
     fit_func29->SetParName(27,"A_VD");
     fit_func29->SetParName(28,"Tau_VD");
     fit_func29->SetNpx(1000000);

     fit_func30= new TF1("fprec30", fprec30,  30000,  309000, 30);
     fit_func30->SetParNames("A", "Blind R", "Phi");
     fit_func30->SetParName(3,"A_cbo_N");
     fit_func30->SetParName(4,"Tau_cbo");
     fit_func30->SetParName(5,"omega_cbo");
     fit_func30->SetParName(6,"phi_cbo_N");
     fit_func30->SetParName(7,"A_cbo_A");
     fit_func30->SetParName(8,"phi_cbo_A");
     fit_func30->SetParName(9,"A_cbo_phi");
     fit_func30->SetParName(10,"phi_cbo_phi");
     fit_func30->SetParName(11,"A_2cbo");
     fit_func30->SetParName(12,"Tau_2cbo");
     fit_func30->SetParName(13,"omega_2cbo");
     fit_func30->SetParName(14,"phi_2cbo");
     fit_func30->SetParName(15,"A_y");
     fit_func30->SetParName(16,"Tau_y");
     fit_func30->SetParName(17,"omega_y");
     fit_func30->SetParName(18,"phi_y");
     fit_func30->SetParName(19,"A_vw");
     fit_func30->SetParName(20,"Tau_vw");
     fit_func30->SetParName(21,"omega_vw");
     fit_func30->SetParName(22,"phi_vw");
     fit_func30->SetParName(23,"A_new");
     fit_func30->SetParName(24,"Tau_new");
     fit_func30->SetParName(25,"omega_new");
     fit_func30->SetParName(26,"phi_new");
     fit_func30->SetParName(27,"A_VD");
     fit_func30->SetParName(28,"Tau_VD");
     fit_func30->SetParName(29,"lm_amp");
     fit_func30->SetNpx(1000000);
	...
	fit_func3->SetParameters(0.23, 0.0, 4.01);
        ...
        if(useFR)
	  {
	    hcalo=construct_rhist_rand(hcomp_sum1[1],hcomp_sum2[1],hcomp_sum3[1],hcomp_sum4[1],hr1[1],hr2[1],hr3[1],hr4[1]);
	  }
	else
	  {
           hcalo=construct_rhist_rand(hr1[1],hr2[1],hr3[1],hr4[1],hr1[1],hr2[1],hr3[1],hr4[1]);
	  }
	...
	hcalo->Reset();
	  ...
	  {
           hcalo=construct_rhist_rand(hr1[i],hr2[i],hr3[i],hr4[i],hr1[i],hr2[i],hr3[i],hr4[i]);
	  }
	...
	hcalo->GetXaxis()->SetTitle("time [ns]");
        ...
        freq[0]=fit_func3->GetParameter(1);
        dfreq[0]=fit_func3->GetParError(1);
        ...
        fit_func7->SetParameter(3, 0.001);
        fit_func7->SetParameter(4, 240000);
        fit_func7->SetParameter(5, 0.00233);
        fit_func7->SetParameter(6, 5.5);

   
        hcalo->Fit("fprec7","RE","",fit_start,fit_stop);
      		
       freq[1]=fit_func7->GetParameter(1);
       dfreq[1]=fit_func7->GetParError(1);
       ...
       fit_func11->SetParameter(7, 0.0004);
       fit_func11->SetParameter(8, 1.5);
       fit_func11->SetParameter(9, 0.0001);
       fit_func11->SetParameter(10, 2.1);


    
       hcalo->Fit("fprec11","RE","",fit_start,fit_stop);
      		
       freq[2]=fit_func11->GetParameter(1);
       dfreq[2]=fit_func11->GetParError(1);
       ...
       fit_func19->SetParameter(15, 0.0005);
       fit_func19->FixParameter(16, 96000);
       fit_func19->FixParameter(17, 0.013896);
       fit_func19->SetParameter(18, 1.6);

      
       hcalo->Fit("fprec19","RE","",fit_start,fit_stop);

       freq[4]=fit_func19->GetParameter(1);
       dfreq[4]=fit_func19->GetParError(1);
       ...
       fit_func23->SetParameter(20, 25000);
       fit_func23->SetParameter(21, 0.01405);
       fit_func23->SetParameter(22, 1.6);


      
       hcalo->Fit("fprec23","RE","",fit_start,fit_stop);

       	freq[5]=fit_func23->GetParameter(1);
       dfreq[5]=fit_func23->GetParError(1);


       fit_func27->SetParameter(0, fit_func23->GetParameter(0));
       fit_func27->SetParameter(1, fit_func23->GetParameter(1));
       fit_func27->SetParameter(2, fit_func23->GetParameter(2));
       fit_func27->SetParameter(3, fit_func23->GetParameter(3));
       fit_func27->SetParameter(4, fit_func23->GetParameter(4));
       fit_func27->SetParameter(5, fit_func23->GetParameter(5));
       fit_func27->SetParameter(6, fit_func23->GetParameter(6));
       fit_func27->SetParameter(7, fit_func23->GetParameter(7));
       fit_func27->SetParameter(8, fit_func23->GetParameter(8));
       fit_func27->SetParameter(9, fit_func23->GetParameter(9));
       fit_func27->SetParameter(10, fit_func23->GetParameter(10));
       fit_func27->SetParameter(11, fit_func23->GetParameter(11));
       fit_func27->FixParameter(12, fit_func23->GetParameter(12));
       fit_func27->FixParameter(13, fit_func23->GetParameter(13));
       fit_func27->SetParameter(14, fit_func23->GetParameter(14));
       fit_func27->SetParameter(15, fit_func23->GetParameter(15));
       fit_func27->SetParameter(16, fit_func23->GetParameter(16));
       fit_func27->SetParameter(17, fit_func23->GetParameter(17));
       fit_func27->SetParameter(18, fit_func23->GetParameter(18));
       fit_func27->SetParameter(19, fit_func23->GetParameter(19));
       fit_func27->SetParameter(20, fit_func23->GetParameter(20));
       fit_func27->SetParameter(21, fit_func23->GetParameter(21));
       fit_func27->SetParameter(22, fit_func23->GetParameter(22));
       fit_func27->SetParameter(23, 0.0001);
       fit_func27->FixParameter(24, 36000);
       fit_func27->FixParameter(25, 0.012);
       fit_func27->SetParameter(26, 2.5);
       
       
      
       hcalo->Fit("fprec27","RE","",fit_start,fit_stop);

       freq[6]=fit_func27->GetParameter(1);
       dfreq[6]=fit_func27->GetParError(1);

       fit_func29->SetParameter(0, fit_func27->GetParameter(0));
       fit_func29->SetParameter(1, fit_func27->GetParameter(1));
       fit_func29->SetParameter(2, fit_func27->GetParameter(2));
       fit_func29->SetParameter(3, fit_func27->GetParameter(3));
       fit_func29->SetParameter(4, fit_func27->GetParameter(4));
       fit_func29->SetParameter(5, fit_func27->GetParameter(5));
       fit_func29->SetParameter(6, fit_func27->GetParameter(6));
       fit_func29->SetParameter(7, fit_func27->GetParameter(7));
       fit_func29->SetParameter(8, fit_func27->GetParameter(8));
       fit_func29->SetParameter(9, fit_func27->GetParameter(9));
       fit_func29->SetParameter(10, fit_func27->GetParameter(10));
       fit_func29->SetParameter(11, fit_func27->GetParameter(11));
       fit_func29->FixParameter(12, fit_func27->GetParameter(12));
       fit_func29->FixParameter(13, fit_func27->GetParameter(13));
       fit_func29->SetParameter(14, fit_func27->GetParameter(14));
       fit_func29->SetParameter(15, fit_func27->GetParameter(15));
       fit_func29->SetParameter(16, fit_func27->GetParameter(16));
       fit_func29->SetParameter(17, fit_func27->GetParameter(17));
       fit_func29->SetParameter(18, fit_func27->GetParameter(18));
       fit_func29->SetParameter(19, fit_func27->GetParameter(19));
       fit_func29->SetParameter(20, fit_func27->GetParameter(20));
       fit_func29->SetParameter(21, fit_func27->GetParameter(21));
       fit_func29->SetParameter(22, fit_func27->GetParameter(22));
       fit_func29->SetParameter(23, fit_func27->GetParameter(23));
       fit_func29->FixParameter(24, fit_func27->GetParameter(24));
       fit_func29->FixParameter(25, fit_func27->GetParameter(25));
       fit_func29->SetParameter(26, fit_func27->GetParameter(26));
       fit_func29->SetParameter(27, 0.001);
       fit_func29->FixParameter(28, 13000);
       
       
      
       hcalo->Fit("fprec29","RE","",fit_start,fit_stop);

       freq[7]=fit_func29->GetParameter(1);
       dfreq[7]=fit_func29->GetParError(1);

       fit_func30->SetParameter(0, fit_func29->GetParameter(0));
       fit_func30->SetParameter(1, fit_func29->GetParameter(1));
       fit_func30->SetParameter(2, fit_func29->GetParameter(2));
       fit_func30->SetParameter(3, fit_func29->GetParameter(3));
       fit_func30->SetParameter(4, fit_func29->GetParameter(4));
       fit_func30->SetParameter(5, fit_func29->GetParameter(5));
       fit_func30->SetParameter(6, fit_func29->GetParameter(6));
       fit_func30->SetParameter(7, fit_func29->GetParameter(7));
       fit_func30->SetParameter(8, fit_func29->GetParameter(8));
       fit_func30->SetParameter(9, fit_func29->GetParameter(9));
       fit_func30->SetParameter(10, fit_func29->GetParameter(10));
       fit_func30->SetParameter(11, fit_func29->GetParameter(11));
       fit_func30->FixParameter(12, fit_func29->GetParameter(12));
       fit_func30->FixParameter(13, fit_func29->GetParameter(13));
       fit_func30->SetParameter(14, fit_func29->GetParameter(14));
       fit_func30->SetParameter(15, fit_func29->GetParameter(15));
       fit_func30->SetParameter(16, fit_func29->GetParameter(16));
       fit_func30->SetParameter(17, fit_func29->GetParameter(17));
       fit_func30->SetParameter(18, fit_func29->GetParameter(18));
       fit_func30->SetParameter(19, fit_func29->GetParameter(19));
       fit_func30->SetParameter(20, fit_func29->GetParameter(20));
       fit_func30->SetParameter(21, fit_func29->GetParameter(21));
       fit_func30->SetParameter(22, fit_func29->GetParameter(22));
       fit_func30->SetParameter(23, fit_func29->GetParameter(23));
       fit_func30->FixParameter(24, fit_func29->GetParameter(24));
       fit_func30->FixParameter(25, fit_func29->GetParameter(25));
       fit_func30->SetParameter(26, fit_func29->GetParameter(26));
       fit_func30->SetParameter(27, fit_func29->GetParameter(27));
       fit_func30->FixParameter(28, fit_func29->GetParameter(28));
       fit_func30->SetParameter(29, 0.0);
       
       
      
       hcalo->Fit("fprec30","RE","",fit_start,fit_stop);

       freq[8]=fit_func30->GetParameter(1);
       dfreq[8]=fit_func30->GetParError(1);
	...
	for (int ibin = ((fit_start + 1- hcalo->GetBinLowEdge(1))/hcalo->GetBinWidth(1))+1; ibin <= ((fit_stop + 1 - hcalo->GetBinLowEdge(1))/hcalo->GetBinWidth(1))+1; ++ibin)
        {
          ...
          double res =  (hcalo->GetBinContent(ibin)- fit_func30->Eval( hcalo->GetBinCenter(ibin) ) );
...
;
  ...
  c2 = new TCanvas("c2","run3no calo scan residuals");
  c2->Divide(8,4);
  c3 = new TCanvas("c3","run3no calo scan fft");
  c3->Divide(8,4);
 ...
 for(int i=1;i<=1;i++)
   {
    ...
    gr1->SetTitle("chisq vs random seed");
    gr1->GetXaxis()->SetTitle("random seed");
    ...
    gr2->SetTitle("A vs random seed");
    gr2->GetXaxis()->SetTitle("random seed");
    ...
    gr3->SetTitle("blindR vs random seed");
    gr3->GetXaxis()->SetTitle("random seed");
    ...
    gr4->SetTitle("phase vs random seed");
    gr4->GetXaxis()->SetTitle("random seed");
    gr4->GetYaxis()->SetTitle("phi_0");
    gr4->SetMarkerStyle(20);
    gr4->SetLineColor(kBlue);
    gr4->Draw("ap");

    c4=new TCanvas("c4","run 3no cbo vs random seed");
    c4->Divide(2,2);
    c4->cd(1);
    gr8=new TGraphErrors(m,n,A_cbo_N,0,dA_cbo_N);
    gr8->SetTitle("A_cbo_N vs random seed");
    gr8->GetXaxis()->SetTitle("random seed");
    ...
    gr5->SetTitle("tau_cbo_ vs random seed");
    gr5->GetXaxis()->SetTitle("random seed");
    ...
    gr6->SetTitle("omega_cbo vs random seed");
    gr6->GetXaxis()->SetTitle("random seed");
    ...
    gr7->SetTitle("phi_cbo_N vs random seed");
    gr7->GetXaxis()->SetTitle("random seed");
    gr7->GetYaxis()->SetTitle("phi_cbo_N");
    gr7->SetMarkerStyle(20);
    gr7->SetLineColor(kBlue);
    gr7->Draw("ap");
 
    c6=new TCanvas("c6","run 3no A,phi,cbo vs random seed");
    c6->Divide(2,2);
    c6->cd(1);
    gr13=new TGraphErrors(m,n,A_cbo_A,0,dA_cbo_A);
    gr13->SetTitle("A_cbo_A vs random seed");
    gr13->GetXaxis()->SetTitle("random seed");
    ...
    gr14->SetTitle("phi_cbo_A vs random seed");
    gr14->GetXaxis()->SetTitle("random seed");
    ...
    gr15->SetTitle("A_cbo_phi vs random seed");
    gr15->GetXaxis()->SetTitle("random seed");
    ...
    gr16->SetTitle("phi_cbo_phi vs random seed");
    gr16->GetXaxis()->SetTitle("random seed");
    ...
    gr16->Draw("ap");
     ...
     c7=new TCanvas("c7","run 3no 2cbo vs random seed");
     c7->Divide(2,2);
    c7->cd(1);
    gr17=new TGraphErrors(m,n,A_2cbo,0,dA_2cbo);
    gr17->SetTitle("A_2cbo vs randoom seed");
    gr17->GetXaxis()->SetTitle("random seed");
    ...
    gr18->SetTitle("tau_2cbo_ vs random seed");
    gr18->GetXaxis()->SetTitle("random seed");
    ...
    gr19->SetTitle("omega_2cbo vs random seed");
    gr19->GetXaxis()->SetTitle("random seed");
    ...
    gr20->SetTitle("phi_2cbo vs random seed");
    gr20->GetXaxis()->SetTitle("random seed");
    ...
    c8=new TCanvas("c8","run 3no vw vs fit start time");
    c8->Divide(2,2);
    c8->cd(1);
    gr21=new TGraphErrors(m,n,A_vw,0,dA_vw);
    gr21->SetTitle("A_vw vs random seed");
    gr21->GetXaxis()->SetTitle("random seed");
    ...
    gr22->SetTitle("tau_vw vs random seed");
    gr22->GetXaxis()->SetTitle("random seed");
    ...
    gr23->SetTitle("omega_vw vs random seed");
    gr23->GetXaxis()->SetTitle("random seed");
    ...
    gr24->SetTitle("phi_vw vs random seed");
    gr24->GetXaxis()->SetTitle("random seed");
    ...
    c9=new TCanvas("c9","run 3no y vs random seed");
    c9->Divide(2,2);
    c9->cd(1);
    gr25=new TGraphErrors(m,n,A_y,0,dA_y);
    gr25->SetTitle("A_y vs fit random seed");
    gr25->GetXaxis()->SetTitle("random seed");
    ...
    gr26->SetTitle("tau_y vs random seed");
    gr26->GetXaxis()->SetTitle("random seed");
    ...
    gr27->SetTitle("omega_y vs random seed");
    gr27->GetXaxis()->SetTitle("random sees");
    ...
    gr28->SetTitle("phi_y vs random seed");
    gr28->GetXaxis()->SetTitle("random seed");
