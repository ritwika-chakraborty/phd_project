...
void run3btom_randomized_oneseed_starttime()
{
...
;
  ...
  c2 = new TCanvas("c2","run3btom start time residuals");
  c2->Divide(6,3);
  c3 = new TCanvas("c3","run3btom start time fft");
  c3->Divide(6,3);
 ...
 for(int i=1;i<=18;i++)
   {
    ...
    c1=new TCanvas("c1","run3btom blind R vs fit start time");
    c1->Divide(2,2);
    c1->cd(1);
    ...
    c4=new TCanvas("c4","run3btom cbo vs fit start time");
    c4->Divide(2,2);
    c4->cd(1);
    ...
    c6=new TCanvas("c6","run3btom A,phi,cbo vs fit start time");
    c6->Divide(2,2);
    c6->cd(1);
    ...
    gkband11m->Draw("same");
     ...
     c7=new TCanvas("c7","run3btom 2cbo vs fit start time");
     c7->Divide(2,2);
    c7->cd(1);
    ...
    c8=new TCanvas("c8","run3btom vw vs fit start time");
    c8->Divide(2,2);
    c8->cd(1);
    ...
    c9=new TCanvas("c9","run3btom y vs fit start time");
    c9->Divide(2,2);
    c9->cd(1);
