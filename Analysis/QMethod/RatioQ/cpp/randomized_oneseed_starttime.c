...
void randomized_oneseed_starttime()
{
...
;
  ...
  c2 = new TCanvas("c2","run 2 start time residuals");
  c2->Divide(6,3);
  c3 = new TCanvas("c3","run 2 start time fft");
  c3->Divide(6,3);
 ...
 for(int i=1;i<=18;i++)
   {
    ...
    c1=new TCanvas("c1","run 2 blind R vs fit start time");
    c1->Divide(2,2);
    c1->cd(1);
    ...
    c4=new TCanvas("c4","run 2 cbo vs fit start time");
    c4->Divide(2,2);
    c4->cd(1);
    ...
    c6=new TCanvas("c6","run 2 A,phi,cbo vs fit start time");
    c6->Divide(2,2);
    c6->cd(1);
    ...
    gkband11m->Draw("same");
     ...
     c7=new TCanvas("c7","run 2 2cbo vs fit start time");
     c7->Divide(2,2);
    c7->cd(1);
    ...
    c9=new TCanvas("c9","run 2 y vs fit start time");
    c9->Divide(2,2);
    c9->cd(1);
