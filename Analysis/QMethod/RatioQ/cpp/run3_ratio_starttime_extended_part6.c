...
void run3_ratio_starttime_extended_part6()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   chisq_6=new TH1D("chisq_6","chisq_6",3,0,3);
     ...
     fit_func23->SetNpx(1000000);
       ...
       fit_func23->SetParameter(3, -0.00117);
       //fit_func23->SetParameter(4, 222700);
       ...
       fit_func23->SetParameter(7, 0.00024);
       fit_func23->SetParameter(8, 31.8);
       fit_func23->SetParameter(9, -0.000148);
       fit_func23->SetParameter(10, 23.7);
       fit_func23->SetParameter(11, 0.00164);
       //fit_func23->SetParameter(12, 38037);
       //fit_func23->SetParameter(13, 0.014051);
       fit_func23->FixParameter(12, 22688.5);
       fit_func23->FixParameter(13,  0.0140631);
       fit_func23->SetParameter(14, 5.45);
       fit_func23->SetParameter(15, -0.00085);
       //fit_func23->SetParameter(16, 62329);
       //fit_func23->SetParameter(17, 0.013899);
       fit_func23->FixParameter(16, 74647.8);
       fit_func23->FixParameter(17, 0.0138950);
       fit_func23->SetParameter(18, -3.2);
       fit_func23->SetParameter(19, -0.000056);
       fit_func23->FixParameter(20, 95639);
       fit_func23->FixParameter(21, 0.004662);
       fit_func23->SetParameter(22, -0.49);
 ...
 for(int i=1;i<=3;i++)
  ...
  foutput=new TFile("run3_starttime_output_corr_fixed_extended_part6.root","new");
