...
void run2_randomized_oneseed_caloscan()
{
 ...
 for(int i=1;i<=24;i++)
  ...
  //hrsum= new TH1D("calo histogram sum ratio", "calosum ratio", hsum1->GetNbinsX(), 100001, 352001);
	...
	//	hcalo->Draw("same");
       ...
       fit_func19->FixParameter(16, 94208);
       fit_func19->FixParameter(17, 0.013924);
       ...
       fit_func23->FixParameter(20, 25630);
       fit_func23->FixParameter(21, 0.014025);
 ...
 for(int i=1;i<=24;i++)
   {
    ...
    c1=new TCanvas("c1","run2 blind R vs calorimeter");
    c1->Divide(2,2);
    c1->cd(1);
    ...
    c4=new TCanvas("c4","run2 cbo vs caloriemeter");
    c4->Divide(2,2);
    c4->cd(1);
    ...
    c6=new TCanvas("c6","run2 A,phi,cbo vs caloriemeter");
    c6->Divide(2,2);
    c6->cd(1);
    ...
    gr16->Draw("ap");
     ...
     c7=new TCanvas("c7","run2 2cbo vs caloriemeter");
     c7->Divide(2,2);
    c7->cd(1);
    ...
    c8=new TCanvas("c8","run2 vw vs caloriemeter");
    c8->Divide(2,2);
    c8->cd(1);
    ...
    c9=new TCanvas("c9","run2 y vs caloriemeter");
    c9->Divide(2,2);
    c9->cd(1);
    ...
    c10=new TCanvas("c10","run 2 R vs caloriemeter");
    ...
    c11=new TCanvas("c11","run 2 R vs caloriemeter");
    ...
    c12=new TCanvas("c12","run 2 R vs caloriemeter");
