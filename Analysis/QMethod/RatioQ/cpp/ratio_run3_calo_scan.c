  ...
  hlm->SetName("hlm");
	...
	*/
       ...
       */
        ...
        fit_func7->FixParameter(4, 198200);
        fit_func7->FixParameter(5, 0.002331);
	...
	//  	hr_sum->Fit("fprec7","RE","",fit_start,fit_stop);
       ...
       fit_func19->FixParameter(16, 36949.4);
       fit_func19->FixParameter(17, 0.014286);
       ...
       fit_func23->FixParameter(20, 61252);
       fit_func23->FixParameter(21, 0.01391);
