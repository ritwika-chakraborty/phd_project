...
void run3_ratio_starttime_extended_part3()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   chisq_3=new TH1D("chisq_3","chisq_3",3,0,3);
     ...
     fit_func23->SetNpx(1000000);
       ...
       fit_func23->SetParameter(3, -0.00121);
       //fit_func23->SetParameter(4, 210900);
       //fit_func23->SetParameter(5, 0.002332);
       fit_func23->FixParameter(4, 191153);
       fit_func23->FixParameter(5, 0.00233128);
       fit_func23->SetParameter(6, -2.76);
       fit_func23->SetParameter(7, 0.00034);
       fit_func23->SetParameter(8, 38.37);
       fit_func23->SetParameter(9, -0.000137);
       fit_func23->SetParameter(10, 36.68);
       fit_func23->SetParameter(11, 0.00322);
       //fit_func23->SetParameter(12, 27412);
       //fit_func23->SetParameter(13, 0.014058);
       fit_func23->FixParameter(12, 22688.5);
       fit_func23->FixParameter(13,  0.0140631);
       fit_func23->SetParameter(14, 4.97);
       fit_func23->SetParameter(15, -0.000621);
       //fit_func23->SetParameter(16, 78388);
       //fit_func23->SetParameter(17, 0.013898);
       fit_func23->FixParameter(16, 74647.8);
       fit_func23->FixParameter(17, 0.0138950);
       fit_func23->SetParameter(18, -3.154);
       fit_func23->SetParameter(19, -0.0000314);
       fit_func23->FixParameter(20, 95639);
       fit_func23->FixParameter(21, 0.004662);
       fit_func23->SetParameter(22, -0.355);
 ...
 for(int i=1;i<=3;i++)
  ...
  foutput=new TFile("run3_starttime_output_corr_fixed_extended_part3.root","new");
