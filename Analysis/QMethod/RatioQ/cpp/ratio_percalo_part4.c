...
void ratio_percalo_part4()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   A_4=new TH1D("A_4","A_4",4,0,4);
   blindR_4=new TH1D("blindR_4","blindR_4",4,0,4);
   phi_0_4=new TH1D("phi_0_4","phi_0_4",4,0,4);
   A_cbo_N_4=new TH1D("A_cbo_N_4","A_cbo_N_4",4,0,4);
   tau_cbo_4=new TH1D("tau_cbo_4","tau_cbo_4",4,0,4);
   omega_cbo_4=new TH1D("omega_cbo_4","omega_cbo_4",4,0,4);
   phi_cbo_N_4=new TH1D("phi_cbo_N_4","phi_cbo_N_4",4,0,4);
   A_cbo_A_4=new TH1D("A_cbo_A_4","A_cbo_A_4",4,0,4);
   phi_cbo_A_4=new TH1D("phi_cbo_A_4","phi_cbo_A_4",4,0,4);
   A_cbo_phi_4=new TH1D("A_cbo_phi_4","A_cbo_phi_4",4,0,4);
   phi_cbo_phi_4=new TH1D("phi_cbo_phi_4","phi_cbo_phi_4",4,0,4);
   A_vw_4=new TH1D("A_vw_4","A_vw_4",4,0,4);
   tau_vw_4=new TH1D("tau_vw_4","tau_vw_4",4,0,4);
   omega_vw_4=new TH1D("omega_vw_4","omega_vw_4",4,0,4);
   phi_vw_4=new TH1D("phi_vw_4","phi_vw_4",4,0,4);
   A_y_4=new TH1D("A_y_4","A_y_4",4,0,4);
   tau_y_4=new TH1D("tau_y_4","tau_y_4",4,0,4);
   omega_y_4=new TH1D("omega_y_4","omega_y_4",4,0,4);
   phi_y_4=new TH1D("phi_y_4","phi_y_4",4,0,4);
   A_2cbo_4=new TH1D("A_2cbo_4","A_2cbo_4",4,0,4);
   tau_2cbo_4=new TH1D("tau_2cbo_4","tau_2cbo_4",4,0,4);
   omega_2cbo_4=new TH1D("omega_2cbo_4","omega_2cbo_4",4,0,4);
   phi_2cbo_4=new TH1D("phi_2cbo_4","phi_2cbo_4",4,0,4);
   n_4=new TH1D("n_4","n_4",4,0,4);
   
   chisq_4=new TH1D("chisq_4","chisq_4",4,0,4);
  ...
  fit_func15= new TF1("fprec15", fprec15,  30000,  309000, 15);
	...
	hr_sum = construct_rhist_copy(h[i+12]);
	...
	hr_sum->GetXaxis()->SetTitle("time [ns]");
 	...
 	cov2.ResizeTo(hr_sum->FindBin(fit_start), hr_sum->FindBin(fit_stop), hr_sum->FindBin(fit_start), hr_sum->FindBin(fit_stop), -1);
       ...
       fit_func3->SetParameters(0.22, 0.0, 2.22);
        ...
        fit_func7->SetParameter(3, 0.026);
        fit_func7->SetParameter(4, 236100);
        fit_func7->SetParameter(5, 0.0023406);
        fit_func7->SetParameter(6, 1.43);
	...
	hr_sum->Fit("fprec7","RE","",fit_start,fit_stop);
       ...
       fit_func11->SetParameter(8, -0.74);
       fit_func11->SetParameter(9, 0.0025);
       fit_func11->SetParameter(10, -3.9);
       ...
       fit_func19->SetParameter(16, 15000);
       fit_func19->SetParameter(17, 0.0140);
       fit_func19->SetParameter(18, -4.0);
       ...
       A_4->SetBinContent(i,fit_func19->GetParameter(0));
       blindR_4->SetBinContent(i,fit_func19->GetParameter(1));
       phi_0_4->SetBinContent(i,fit_func19->GetParameter(2));
       A_cbo_N_4->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(3)));
       tau_cbo_4->SetBinContent(i,fit_func19->GetParameter(4));
       omega_cbo_4->SetBinContent(i,fit_func19->GetParameter(5));
       phi_cbo_N_4->SetBinContent(i,fit_func19->GetParameter(6));
       A_cbo_A_4->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(7)));
       phi_cbo_A_4->SetBinContent(i,fit_func19->GetParameter(8));
       A_cbo_phi_4->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(9)));
       phi_cbo_phi_4->SetBinContent(i,fit_func19->GetParameter(10));
       //A_vw_4->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       //tau_vw_4->SetBinContent(i,fit_func19->GetParameter(12));
       //omega_vw_4->SetBinContent(i,fit_func19->GetParameter(13));
       //phi_vw_4->SetBinContent(i,fit_func19->GetParameter(14));
       A_y_4->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(15)));
       tau_y_4->SetBinContent(i,fit_func19->GetParameter(16));
       omega_y_4->SetBinContent(i,fit_func19->GetParameter(17));
       phi_y_4->SetBinContent(i,fit_func19->GetParameter(18));
       A_2cbo_4->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       tau_2cbo_4->SetBinContent(i,fit_func19->GetParameter(12));
       omega_2cbo_4->SetBinContent(i,fit_func19->GetParameter(13));
       phi_2cbo_4->SetBinContent(i,fit_func19->GetParameter(14));

     
       chisq_4->SetBinContent(i,fit_func19->GetChisquare()/fit_func19->GetNDF());
       ...
       while(phi_2cbo_4->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
       ...
       A_4->SetBinError(i,fit_func19->GetParError(0));
       blindR_4->SetBinError(i,fit_func19->GetParError(1));
       phi_0_4->SetBinError(i,fit_func19->GetParError(2));
       A_cbo_N_4->SetBinError(i,fit_func19->GetParError(3));
       tau_cbo_4->SetBinError(i,fit_func19->GetParError(4));
       omega_cbo_4->SetBinError(i,fit_func19->GetParError(5));
       phi_cbo_N_4->SetBinError(i,fit_func19->GetParError(6));
       A_cbo_A_4->SetBinError(i,fit_func19->GetParError(7));
       phi_cbo_A_4->SetBinError(i,fit_func19->GetParError(8));
       A_cbo_phi_4->SetBinError(i,fit_func19->GetParError(9));
       phi_cbo_phi_4->SetBinError(i,fit_func19->GetParError(10));
       //A_vw_4->SetBinError(i,fit_func19->GetParError(11));
       //tau_vw_4->SetBinError(i,fit_func19->GetParError(12));
       //omega_vw_4->SetBinError(i,fit_func19->GetParError(13));
       //phi_vw_4->SetBinError(i,fit_func19->GetParError(14));
       A_y_4->SetBinError(i,fit_func19->GetParError(15));
       tau_y_4->SetBinError(i,fit_func19->GetParError(16));
       omega_y_4->SetBinError(i,fit_func19->GetParError(17));
       phi_y_4->SetBinError(i,fit_func19->GetParError(18));
       A_2cbo_4->SetBinError(i,fit_func19->GetParError(11));
       tau_2cbo_4->SetBinError(i,fit_func19->GetParError(12));
       omega_2cbo_4->SetBinError(i,fit_func19->GetParError(13));
       phi_2cbo_4->SetBinError(i,fit_func19->GetParError(14));

     
       n_4->SetBinContent(i,i+12);
       m=m+1;
 ...
 for(int i=1;i<=4;i++)
   ...
   foutput=new TFile("percalo_output_part4.root","new");
