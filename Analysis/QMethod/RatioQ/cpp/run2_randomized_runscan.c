...
char root_file_name_1[128] = "r2c_w8.root";
char root_file_name_2[128] = "r2d_w8.root";
char root_file_name_3[128] = "r2e_w8.root";
char root_file_name_4[128] = "r2f_w8.root";
char root_file_name_5[128] = "r2g_w8.root";
char root_file_name_6[128] = "r2h_w8.root";
  ...
  for(int id=1;id<=6;id++)
    {
      ...
      */
      //for(int i=1;i<=24;i++)
      //{
       hr1[id]= (TH1D*)(_file[id]->FindObjectAny(TString::Format("qHist1D_sig_rm_sum_0_1")));
       // hr1[id]->Add(hrcalo1[i],1);
       hr2[id]= (TH1D*)(_file[id]->FindObjectAny(TString::Format("qHist1D_sig_rm_sum_1_1")));
       // hr2[id]->Add(hrcalo2[i],1);
       hr3[id]= (TH1D*)(_file[id]->FindObjectAny(TString::Format("qHist1D_sig_rm_sum_2_1")));
       // hr3[id]->Add(hrcalo3[i],1);
       hr4[id]= (TH1D*)(_file[id]->FindObjectAny(TString::Format("qHist1D_sig_rm_sum_3_1")));
  ...
  //hrsum= new TH1D("calo histogram sum ratio", "calosum ratio", hsum1->GetNbinsX(), 100001, 352001);
   ...
   hcomp_sum4[i]->Scale(0.5);
	...
	hcalo->GetXaxis()->SetTitle("time [ns]");
        ...
        fit_func7->SetParameter(5, 0.002341);
        fit_func7->SetParameter(6, 5.7);
	...
	hcalo->Fit("fprec7","RE","",fit_start,fit_stop);
       ...
       fit_func11->SetParameter(9, 0.0007);
       ...
       fit_func23->SetParameter(22, 4.1);
