...
Int_t m=0;
TH1D *chisq_5, *A_5, *blindR_5, *phi_0_5, *A_cbo_N_5, *tau_cbo_5, *omega_cbo_5, *phi_cbo_N_5, *A_cbo_A_5, *phi_cbo_A_5, *A_cbo_phi_5, *phi_cbo_phi_5, *A_vw_5, *tau_vw_5, *omega_vw_5, *phi_vw_5, *A_y_5, *tau_y_5, *omega_y_5, *phi_y_5, *A_2cbo_5, *tau_2cbo_5, *omega_2cbo_5, *phi_2cbo_5,*n_5;
Int_t countfcn=0;
Double_t ch=0;
...
void ratio_starttime_part5()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   A_5=new TH1D("A_5","A_5",3,0,3);
   blindR_5=new TH1D("blindR_5","blindR_5",3,0,3);
   phi_0_5=new TH1D("phi_0_5","phi_0_5",3,0,3);
   A_cbo_N_5=new TH1D("A_cbo_N_5","A_cbo_N_5",3,0,3);
   tau_cbo_5=new TH1D("tau_cbo_5","tau_cbo_5",3,0,3);
   omega_cbo_5=new TH1D("omega_cbo_5","omega_cbo_5",3,0,3);
   phi_cbo_N_5=new TH1D("phi_cbo_N_5","phi_cbo_N_5",3,0,3);
   A_cbo_A_5=new TH1D("A_cbo_A_5","A_cbo_A_5",3,0,3);
   phi_cbo_A_5=new TH1D("phi_cbo_A_5","phi_cbo_A_5",3,0,3);
   A_cbo_phi_5=new TH1D("A_cbo_phi_5","A_cbo_phi_5",3,0,3);
   phi_cbo_phi_5=new TH1D("phi_cbo_phi_5","phi_cbo_phi_5",3,0,3);
   A_vw_5=new TH1D("A_vw_5","A_vw_5",3,0,3);
   tau_vw_5=new TH1D("tau_vw_5","tau_vw_5",3,0,3);
   omega_vw_5=new TH1D("omega_vw_5","omega_vw_5",3,0,3);
   phi_vw_5=new TH1D("phi_vw_5","phi_vw_5",3,0,3);
   A_y_5=new TH1D("A_y_5","A_y_5",3,0,3);
   tau_y_5=new TH1D("tau_y_5","tau_y_5",3,0,3);
   omega_y_5=new TH1D("omega_y_5","omega_y_5",3,0,3);
   phi_y_5=new TH1D("phi_y_5","phi_y_5",3,0,3);
   A_2cbo_5=new TH1D("A_2cbo_5","A_2cbo_5",3,0,3);
   tau_2cbo_5=new TH1D("tau_2cbo_5","tau_2cbo_5",3,0,3);
   omega_2cbo_5=new TH1D("omega_2cbo_5","omega_2cbo_5",3,0,3);
   phi_2cbo_5=new TH1D("phi_2cbo_5","phi_2cbo_5",3,0,3);
   n_5=new TH1D("n_5","n_5",3,0,3);
   
   chisq_5=new TH1D("chisq_5","chisq_5",3,0,3);
     ...
     fit_func23->SetNpx(1000000);
       ...
       //fit_func23->SetParameter(4, 258500);
       //fit_func23->SetParameter(5, 0.00234087);
       fit_func23->FixParameter(4, 243936.11);
       fit_func23->FixParameter(5, 0.0023403791);

       fit_func23->SetParameter(6, 0.44);
       fit_func23->SetParameter(7, 0.00072);
       fit_func23->SetParameter(8, 0.41);
       fit_func23->SetParameter(9, -0.00012);
       fit_func23->SetParameter(10, -18.9);
       fit_func23->SetParameter(11, 0.0026);
       //fit_func23->SetParameter(12, 29700);
       //fit_func23->SetParameter(13, 0.014038);
       fit_func23->FixParameter(12, 28629.107);
       fit_func23->FixParameter(13,  0.014037648);

       fit_func23->SetParameter(14, 2.9);
       fit_func23->SetParameter(15, 0.00029);
       //fit_func23->SetParameter(16, 117000);
       //fit_func23->SetParameter(17, 0.01393);
       fit_func23->FixParameter(16, 111541.29);
       fit_func23->FixParameter(17, 0.013931315);

       fit_func23->SetParameter(18, 6.03);
       fit_func23->SetParameter(19, 0.00016);
       //fit_func23->SetParameter(20, 114000);
       //fit_func23->SetParameter(21, 0.00469);
       fit_func23->FixParameter(20, (243936.11/2));
       fit_func23->FixParameter(21, (2*0.0023403791));


       fit_func23->SetParameter(22, 2.66);
	...
	*/ 
       ...
       A_5->SetBinContent(i,fit_func23->GetParameter(0));
       blindR_5->SetBinContent(i,fit_func23->GetParameter(1));
       phi_0_5->SetBinContent(i,fit_func23->GetParameter(2));
       A_cbo_N_5->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(3)));
       tau_cbo_5->SetBinContent(i,fit_func23->GetParameter(4));
       omega_cbo_5->SetBinContent(i,fit_func23->GetParameter(5));
       phi_cbo_N_5->SetBinContent(i,fit_func23->GetParameter(6));
       A_cbo_A_5->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(7)));
       phi_cbo_A_5->SetBinContent(i,fit_func23->GetParameter(8));
       A_cbo_phi_5->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(9)));
       phi_cbo_phi_5->SetBinContent(i,fit_func23->GetParameter(10));
       A_vw_5->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(11)));
       tau_vw_5->SetBinContent(i,fit_func23->GetParameter(12));
       omega_vw_5->SetBinContent(i,fit_func23->GetParameter(13));
       phi_vw_5->SetBinContent(i,fit_func23->GetParameter(14));
       A_y_5->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(15)));
       tau_y_5->SetBinContent(i,fit_func23->GetParameter(16));
       omega_y_5->SetBinContent(i,fit_func23->GetParameter(17));
       phi_y_5->SetBinContent(i,fit_func23->GetParameter(18));
       A_2cbo_5->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(19)));
       tau_2cbo_5->SetBinContent(i,fit_func23->GetParameter(20));
       omega_2cbo_5->SetBinContent(i,fit_func23->GetParameter(21));
       phi_2cbo_5->SetBinContent(i,fit_func23->GetParameter(22));

     
       chisq_5->SetBinContent(i,fit_func23->GetChisquare()/fit_func23->GetNDF());


       while(phi_cbo_N_5->GetBinContent(i) < 0.0)
	 {
	   phi_cbo_N_5->SetBinContent(i, phi_cbo_N_5->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_cbo_A_5->GetBinContent(i) < 0.0)
	 {
	   phi_cbo_A_5->SetBinContent(i, phi_cbo_A_5->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_cbo_phi_5->GetBinContent(i) < 0.0)
	 {
	   phi_cbo_phi_5->SetBinContent(i, phi_cbo_phi_5->GetBinContent(i) + (2*(TMath::Pi())));
	 }
       
       while(phi_vw_5->GetBinContent(i) < 0.0)
	 {
	   phi_vw_5->SetBinContent(i, phi_vw_5->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_y_5->GetBinContent(i) < 0.0)
	 {
	   phi_y_5->SetBinContent(i, phi_y_5->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_2cbo_5->GetBinContent(i) < 0.0)
	 {
	   phi_2cbo_5->SetBinContent(i, phi_2cbo_5->GetBinContent(i) + (2*(TMath::Pi())));
	 }

         while(phi_cbo_N_5->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_cbo_N_5->SetBinContent(i, phi_cbo_N_5->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_cbo_A_5->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_cbo_A_5->SetBinContent(i, phi_cbo_A_5->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_cbo_phi_5->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_cbo_phi_5->SetBinContent(i, phi_cbo_phi_5->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_vw_5->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_vw_5->SetBinContent(i, phi_vw_5->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_y_5->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_y_5->SetBinContent(i, phi_y_5->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_2cbo_5->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_2cbo_5->SetBinContent(i, phi_2cbo_5->GetBinContent(i) - (2*(TMath::Pi())));
	 }
       
       A_5->SetBinError(i,fit_func23->GetParError(0));
       blindR_5->SetBinError(i,fit_func23->GetParError(1));
       phi_0_5->SetBinError(i,fit_func23->GetParError(2));
       A_cbo_N_5->SetBinError(i,fit_func23->GetParError(3));
       tau_cbo_5->SetBinError(i,fit_func23->GetParError(4));
       omega_cbo_5->SetBinError(i,fit_func23->GetParError(5));
       phi_cbo_N_5->SetBinError(i,fit_func23->GetParError(6));
       A_cbo_A_5->SetBinError(i,fit_func23->GetParError(7));
       phi_cbo_A_5->SetBinError(i,fit_func23->GetParError(8));
       A_cbo_phi_5->SetBinError(i,fit_func23->GetParError(9));
       phi_cbo_phi_5->SetBinError(i,fit_func23->GetParError(10));
       A_vw_5->SetBinError(i,fit_func23->GetParError(11));
       tau_vw_5->SetBinError(i,fit_func23->GetParError(12));
       omega_vw_5->SetBinError(i,fit_func23->GetParError(13));
       phi_vw_5->SetBinError(i,fit_func23->GetParError(14));
       A_y_5->SetBinError(i,fit_func23->GetParError(15));
       tau_y_5->SetBinError(i,fit_func23->GetParError(16));
       omega_y_5->SetBinError(i,fit_func23->GetParError(17));
       phi_y_5->SetBinError(i,fit_func23->GetParError(18));
       A_2cbo_5->SetBinError(i,fit_func23->GetParError(19));
       tau_2cbo_5->SetBinError(i,fit_func23->GetParError(20));
       omega_2cbo_5->SetBinError(i,fit_func23->GetParError(21));
       phi_2cbo_5->SetBinError(i,fit_func23->GetParError(22));

     
       n_5->SetBinContent(i,fit_start);
       m=m+1;
 ...
 for(int i=1;i<=3;i++)
  ...
  foutput=new TFile("starttime_output_avg_constmat_th_15_part5.root","new");
