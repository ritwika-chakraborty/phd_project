...
void ratio_4h_FR_cov_construct_per_run()
{
...
hcov_29_p->Draw("same");
 hcov_29_m->Draw("same");
    ...
    */
    ...
    //foutput=new TFile("run3K_4hcopy_ratioFR_cov_mat_final.root","new");
   foutput=new TFile("run3b_Ta_2_start.root","new");
   hr_sum->Write();
   hcov->Write();
   foutput->Close();
