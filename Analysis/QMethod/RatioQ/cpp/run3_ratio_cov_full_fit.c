   ...
   //hr_sum->Fit("fprec3","RUE","",fit_start,fit_stop);
	...
	//   hr_sum->Fit("fprec7","RE","",fit_start,fit_stop);
       ...
       //    hr_sum->Fit("fprec15","RE","",fit_start,fit_stop);
          ...
          fit_func19->SetParameter(0, 0.2285);
       fit_func19->SetParameter(1, 0.0);
       fit_func19->SetParameter(2, 2.23);
       fit_func19->SetParameter(3, -0.00127);
       fit_func19->SetParameter(4, 190600);
       fit_func19->SetParameter(5, 0.002331);
       fit_func19->SetParameter(6, -2.7);
       fit_func19->SetParameter(7, 0.00032);
       fit_func19->SetParameter(8, 44);
       fit_func19->SetParameter(9, 0.00008);
       fit_func19->SetParameter(10, -4.17);
       ...
       fit_func19->SetParameter(16, 105000);
