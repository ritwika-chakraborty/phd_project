...
void run3_ratio_starttime_extended_part4()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   chisq_4=new TH1D("chisq_4","chisq_4",3,0,3);
     ...
     fit_func23->SetNpx(1000000);
       ...
       fit_func23->SetParameter(3, -0.00125);
       //fit_func23->SetParameter(4, 197800);
       //fit_func23->SetParameter(5, 0.002332);
       fit_func23->FixParameter(4, 191153);
       fit_func23->FixParameter(5, 0.00233128);
       fit_func23->SetParameter(6, -2.77);
       fit_func23->SetParameter(7, 0.00031);
       fit_func23->SetParameter(8, 41.71);
       fit_func23->SetParameter(9, -0.000133);
       fit_func23->SetParameter(10, 52.55);
       fit_func23->SetParameter(11, 0.00213);
       //fit_func23->SetParameter(12, 33616);
       //fit_func23->SetParameter(13, 0.014053);
       fit_func23->FixParameter(12, 22688.5);
       fit_func23->FixParameter(13,  0.0140631);
       fit_func23->SetParameter(14, 5.28);
       fit_func23->SetParameter(15, -0.00073);
       //fit_func23->SetParameter(16, 69645);
       //fit_func23->SetParameter(17, 0.0139);
       fit_func23->FixParameter(16, 74647.8);
       fit_func23->FixParameter(17, 0.0138950);
       fit_func23->SetParameter(18, -3.35);
       fit_func23->SetParameter(19, -0.000038);
       fit_func23->FixParameter(20, 95639);
       fit_func23->FixParameter(21, 0.004662);
       fit_func23->SetParameter(22, -0.17);
 ...
 for(int i=1;i<=3;i++)
  ...
  foutput=new TFile("run3_starttime_output_corr_fixed_extended_part4.root","new");
