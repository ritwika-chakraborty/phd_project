...
Int_t m=0;
TH1D *chisq_2, *A_2, *blindR_2, *phi_0_2, *A_cbo_N_2, *tau_cbo_2, *omega_cbo_2, *phi_cbo_N_2, *A_cbo_A_2, *phi_cbo_A_2, *A_cbo_phi_2, *phi_cbo_phi_2, *A_vw_2, *tau_vw_2, *omega_vw_2, *phi_vw_2, *A_y_2, *tau_y_2, *omega_y_2, *phi_y_2, *A_2cbo_2, *tau_2cbo_2, *omega_2cbo_2, *phi_2cbo_2,*n_2;
Int_t countfcn=0;
Double_t ch=0;
...
void ratio_starttime_part2()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   A_2=new TH1D("A_2","A_2",3,0,3);
   blindR_2=new TH1D("blindR_2","blindR_2",3,0,3);
   phi_0_2=new TH1D("phi_0_2","phi_0_2",3,0,3);
   A_cbo_N_2=new TH1D("A_cbo_N_2","A_cbo_N_2",3,0,3);
   tau_cbo_2=new TH1D("tau_cbo_2","tau_cbo_2",3,0,3);
   omega_cbo_2=new TH1D("omega_cbo_2","omega_cbo_2",3,0,3);
   phi_cbo_N_2=new TH1D("phi_cbo_N_2","phi_cbo_N_2",3,0,3);
   A_cbo_A_2=new TH1D("A_cbo_A_2","A_cbo_A_2",3,0,3);
   phi_cbo_A_2=new TH1D("phi_cbo_A_2","phi_cbo_A_2",3,0,3);
   A_cbo_phi_2=new TH1D("A_cbo_phi_2","A_cbo_phi_2",3,0,3);
   phi_cbo_phi_2=new TH1D("phi_cbo_phi_2","phi_cbo_phi_2",3,0,3);
   A_vw_2=new TH1D("A_vw_2","A_vw_2",3,0,3);
   tau_vw_2=new TH1D("tau_vw_2","tau_vw_2",3,0,3);
   omega_vw_2=new TH1D("omega_vw_2","omega_vw_2",3,0,3);
   phi_vw_2=new TH1D("phi_vw_2","phi_vw_2",3,0,3);
   A_y_2=new TH1D("A_y_2","A_y_2",3,0,3);
   tau_y_2=new TH1D("tau_y_2","tau_y_2",3,0,3);
   omega_y_2=new TH1D("omega_y_2","omega_y_2",3,0,3);
   phi_y_2=new TH1D("phi_y_2","phi_y_2",3,0,3);
   A_2cbo_2=new TH1D("A_2cbo_2","A_2cbo_2",3,0,3);
   tau_2cbo_2=new TH1D("tau_2cbo_2","tau_2cbo_2",3,0,3);
   omega_2cbo_2=new TH1D("omega_2cbo_2","omega_2cbo_2",3,0,3);
   phi_2cbo_2=new TH1D("phi_2cbo_2","phi_2cbo_2",3,0,3);
   n_2=new TH1D("n_2","n_2",3,0,3);
   
   chisq_2=new TH1D("chisq_2","chisq_2",3,0,3);
	...
	*/ 
       ...
       A_2->SetBinContent(i,fit_func23->GetParameter(0));
       blindR_2->SetBinContent(i,fit_func23->GetParameter(1));
       phi_0_2->SetBinContent(i,fit_func23->GetParameter(2));
       A_cbo_N_2->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(3)));
       tau_cbo_2->SetBinContent(i,fit_func23->GetParameter(4));
       omega_cbo_2->SetBinContent(i,fit_func23->GetParameter(5));
       phi_cbo_N_2->SetBinContent(i,fit_func23->GetParameter(6));
       A_cbo_A_2->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(7)));
       phi_cbo_A_2->SetBinContent(i,fit_func23->GetParameter(8));
       A_cbo_phi_2->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(9)));
       phi_cbo_phi_2->SetBinContent(i,fit_func23->GetParameter(10));
       A_vw_2->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(11)));
       tau_vw_2->SetBinContent(i,fit_func23->GetParameter(12));
       omega_vw_2->SetBinContent(i,fit_func23->GetParameter(13));
       phi_vw_2->SetBinContent(i,fit_func23->GetParameter(14));
       A_y_2->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(15)));
       tau_y_2->SetBinContent(i,fit_func23->GetParameter(16));
       omega_y_2->SetBinContent(i,fit_func23->GetParameter(17));
       phi_y_2->SetBinContent(i,fit_func23->GetParameter(18));
       A_2cbo_2->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(19)));
       tau_2cbo_2->SetBinContent(i,fit_func23->GetParameter(20));
       omega_2cbo_2->SetBinContent(i,fit_func23->GetParameter(21));
       phi_2cbo_2->SetBinContent(i,fit_func23->GetParameter(22));

     
       chisq_2->SetBinContent(i,fit_func23->GetChisquare()/fit_func23->GetNDF());


       while(phi_cbo_N_2->GetBinContent(i) < 0.0)
	 {
	   phi_cbo_N_2->SetBinContent(i, phi_cbo_N_2->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_cbo_A_2->GetBinContent(i) < 0.0)
	 {
	   phi_cbo_A_2->SetBinContent(i, phi_cbo_A_2->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_cbo_phi_2->GetBinContent(i) < 0.0)
	 {
	   phi_cbo_phi_2->SetBinContent(i, phi_cbo_phi_2->GetBinContent(i) + (2*(TMath::Pi())));
	 }
       
       while(phi_vw_2->GetBinContent(i) < 0.0)
	 {
	   phi_vw_2->SetBinContent(i, phi_vw_2->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_y_2->GetBinContent(i) < 0.0)
	 {
	   phi_y_2->SetBinContent(i, phi_y_2->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_2cbo_2->GetBinContent(i) < 0.0)
	 {
	   phi_2cbo_2->SetBinContent(i, phi_2cbo_2->GetBinContent(i) + (2*(TMath::Pi())));
	 }

         while(phi_cbo_N_2->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_cbo_N_2->SetBinContent(i, phi_cbo_N_2->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_cbo_A_2->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_cbo_A_2->SetBinContent(i, phi_cbo_A_2->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_cbo_phi_2->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_cbo_phi_2->SetBinContent(i, phi_cbo_phi_2->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_vw_2->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_vw_2->SetBinContent(i, phi_vw_2->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_y_2->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_y_2->SetBinContent(i, phi_y_2->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_2cbo_2->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_2cbo_2->SetBinContent(i, phi_2cbo_2->GetBinContent(i) - (2*(TMath::Pi())));
	 }
       
       A_2->SetBinError(i,fit_func23->GetParError(0));
       blindR_2->SetBinError(i,fit_func23->GetParError(1));
       phi_0_2->SetBinError(i,fit_func23->GetParError(2));
       A_cbo_N_2->SetBinError(i,fit_func23->GetParError(3));
       tau_cbo_2->SetBinError(i,fit_func23->GetParError(4));
       omega_cbo_2->SetBinError(i,fit_func23->GetParError(5));
       phi_cbo_N_2->SetBinError(i,fit_func23->GetParError(6));
       A_cbo_A_2->SetBinError(i,fit_func23->GetParError(7));
       phi_cbo_A_2->SetBinError(i,fit_func23->GetParError(8));
       A_cbo_phi_2->SetBinError(i,fit_func23->GetParError(9));
       phi_cbo_phi_2->SetBinError(i,fit_func23->GetParError(10));
       A_vw_2->SetBinError(i,fit_func23->GetParError(11));
       tau_vw_2->SetBinError(i,fit_func23->GetParError(12));
       omega_vw_2->SetBinError(i,fit_func23->GetParError(13));
       phi_vw_2->SetBinError(i,fit_func23->GetParError(14));
       A_y_2->SetBinError(i,fit_func23->GetParError(15));
       tau_y_2->SetBinError(i,fit_func23->GetParError(16));
       omega_y_2->SetBinError(i,fit_func23->GetParError(17));
       phi_y_2->SetBinError(i,fit_func23->GetParError(18));
       A_2cbo_2->SetBinError(i,fit_func23->GetParError(19));
       tau_2cbo_2->SetBinError(i,fit_func23->GetParError(20));
       omega_2cbo_2->SetBinError(i,fit_func23->GetParError(21));
       phi_2cbo_2->SetBinError(i,fit_func23->GetParError(22));

     
       n_2->SetBinContent(i,fit_start);
       m=m+1;
 ...
 for(int i=1;i<=3;i++)
  ...
  foutput=new TFile("starttime_output_avg_constmat_th_15_part2.root","new");
