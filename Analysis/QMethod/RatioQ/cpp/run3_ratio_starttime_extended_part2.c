...
void run3_ratio_starttime_extended_part2()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   chisq_2=new TH1D("chisq_2","chisq_2",3,0,3);
     ...
     fit_func23->SetNpx(1000000);
       ...
       fit_func23->SetParameter(6, -2.75);
       fit_func23->SetParameter(7, 0.00037);
       fit_func23->SetParameter(8, 35.2);
       fit_func23->SetParameter(9, -0.000117);
       fit_func23->SetParameter(10, -26.4);
       fit_func23->SetParameter(11, 0.00528);
       //fit_func23->SetParameter(12, 21896);
       //fit_func23->SetParameter(13, 0.0140617);
       fit_func23->FixParameter(12, 22688.5);
       fit_func23->FixParameter(13,  0.0140631);
       fit_func23->SetParameter(14, 4.78);
       fit_func23->SetParameter(15, -0.00061);
       //fit_func23->SetParameter(16, 77264);
       //fit_func23->SetParameter(17, 0.013895);
       fit_func23->FixParameter(16, 74647.8);
       fit_func23->FixParameter(17, 0.0138950);
       fit_func23->SetParameter(18, -2.849);
       fit_func23->SetParameter(19, -0.000031);
       fit_func23->FixParameter(20, 95639);
       fit_func23->FixParameter(21, 0.004662);
       fit_func23->SetParameter(22, -0.42);
 ...
 for(int i=1;i<=3;i++)
  ...
  foutput=new TFile("run3_starttime_output_corr_fixed_extended_part2.root","new");
