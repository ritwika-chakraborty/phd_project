...
char root_file_name[128] = "r3btom_w8_xtalreject.root";
...
void run3btom_randomized_FR_fullfit()
{
    ...
    if(useFR)
   {
	...
	hcalo->GetXaxis()->SetTitle("time [ns]");
       ...
       dfreq[0]=fit_func3->GetParError(1);
        ...
        fit_func7->SetParameter(5, 0.002328);
	...
	freq[1]=fit_func7->GetParameter(1);
       ...
       fit_func19->SetParameter(16, 85000);
       fit_func19->SetParameter(17, 0.01389);
       ...
       fit_func23->SetParameter(20, 18500);
       fit_func23->SetParameter(21, 0.014092);
	...
	freq[5]=fit_func23->GetParameter(1);
       ...
       fit_func27->FixParameter(24, 18000);
       ...
       fit_func29->FixParameter(28, 18400);
...
;
  ...
  c2 = new TCanvas("c2","run3btom calo scan residuals");
  c2->Divide(8,4);
  c3 = new TCanvas("c3","run3btom calo scan fft");
  c3->Divide(8,4);
 ...
 c1=new TCanvas("c1","run3btom blind R vs random seed");
    c1->Divide(2,2);
    c1->cd(1);
    ...
    c4=new TCanvas("c4","run3btom cbo vs random seed");
    c4->Divide(2,2);
    c4->cd(1);
    ...
    c6=new TCanvas("c6","run3btom A,phi,cbo vs random seed");
    c6->Divide(2,2);
    c6->cd(1);
    ...
    gr16->Draw("ap");
     ...
     c7=new TCanvas("c7","run3btom 2cbo vs random seed");
     c7->Divide(2,2);
    c7->cd(1);
    ...
    c8=new TCanvas("c8","run 3btom vw vs fit start time");
    c8->Divide(2,2);
    c8->cd(1);
    ...
    c9=new TCanvas("c9","run3btom y vs random seed");
    c9->Divide(2,2);
    c9->cd(1);
