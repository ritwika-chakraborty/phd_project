...
void run3no_randomized_oneseed_caloscan()
{
 ...
 for(int i=1;i<=24;i++)
  ...
  //hrsum= new TH1D("calo histogram sum ratio", "calosum ratio", hsum1->GetNbinsX(), 100001, 352001);
  ...
  else
   {
	...
	fit_func7->SetParameter(4, 190000);
        fit_func7->SetParameter(5, 0.002333);
        fit_func7->SetParameter(6, 1.9+((i-1)*(6.28/24)));
       ...
       fit_func15->SetParameter(11, 0.0001);
       ...
       fit_func19->SetParameter(15, 0.01);
       fit_func19->FixParameter(16, 82100);
       fit_func19->FixParameter(17, 0.013902);
       fit_func19->SetParameter(18, 5.1);
       ...
       fit_func23->FixParameter(20, 4000);
       fit_func23->FixParameter(21, 0.014036);
       fit_func23->SetParameter(22, 2.2+((i-1)*(6.28/24)));  
...
;
  ...
  c2 = new TCanvas("c2","run 3no calo scan residuals");
  c2->Divide(6,4);
  c3 = new TCanvas("c3","run 3no calo scan fft");
  c3->Divide(6,4);
 ...
 for(int i=1;i<=24;i++)
   {
    ...
    c1=new TCanvas("c1","run 3no blind R vs calorimeter");
    c1->Divide(2,2);
    c1->cd(1);
    ...
    c4=new TCanvas("c4","run 3no cbo vs caloriemeter");
    c4->Divide(2,2);
    c4->cd(1);
    ...
    c6=new TCanvas("c6","run 3no A,phi,cbo vs caloriemeter");
    c6->Divide(2,2);
    c6->cd(1);
    ...
    gr16->Draw("ap");
     ...
     c7=new TCanvas("c7","run 3no 2cbo vs caloriemeter");
     c7->Divide(2,2);
    c7->cd(1);
    ...
    c8=new TCanvas("c8","run 3no vw vs caloriemeter");
    c8->Divide(2,2);
    c8->cd(1);
    ...
    c9=new TCanvas("c9","run 3no y vs caloriemeter");
    c9->Divide(2,2);
    c9->cd(1);
    ...
    gr28->Draw("ap");
     ...
     c10=new TCanvas("c10","run 3no R vs caloriemeter");
    ...
    c11=new TCanvas("c11","run 3no R vs caloriemeter");
    ...
    c12=new TCanvas("c12","run 3no R vs caloriemeter");
