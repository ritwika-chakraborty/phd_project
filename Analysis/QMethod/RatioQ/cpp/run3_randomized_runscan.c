...
char root_file_name_1[128] = "r3b_w8_xtalreject.root";
char root_file_name_2[128] = "r3c_w8_xtalreject.root";
char root_file_name_3[128] = "r3d_w8_xtalreject.root";
char root_file_name_4[128] = "r3e_w8_xtalreject.root";
char root_file_name_5[128] = "r3f_w8_xtalreject.root";
char root_file_name_6[128] = "r3g_w8_xtalreject.root";
char root_file_name_7[128] = "r3ij_w8_xtalreject.root";
char root_file_name_8[128] = "r3ij_w8_xtalreject.root";
char root_file_name_9[128] = "r3k_w8_xtalreject.root";
char root_file_name_10[128] = "r3l_w8_xtalreject.root";
char root_file_name_11[128] = "r3m_w8_xtalreject.root";
char root_file_name_12[128] = "r3n_w8_xtalreject.root";
char root_file_name_13[128] = "r3o_w8_xtalreject.root";
...
TFile *_file[50];
TDirectory *dir[50];
TH1D *h[25],*hr1[50],*hr2[50],*hr3[50],*hr4[50],*qHist_1D[50],*h_sum, *h1, *h2, *hp, *hm, *h_ratio, *h_num, *h_deno, *hcalo, *hfit, *hr[50], *h_res[50], *hr_sum, *hsum1,*hsum2,*hsum3,*hsum4,*hcomp_sum1[50],*hcomp_sum2[50],*hcomp_sum3[50],*hcomp_sum4[50],*hr_shift1,*hr_noshift1,*hr_shift2,*hr_noshift2,*hr_shift3,*hr_noshift3,*hr_shift4,*hr_noshift4,*hrcalo1[50],*hrcalo2[50],*hrcalo3[50],*hrcalo4[50];
...
void run3_randomized_runscan()
{
  ...
  _file[4]=TFile::Open(root_file_name_4);
  _file[5]=TFile::Open(root_file_name_5);
  _file[6]=TFile::Open(root_file_name_6);
  _file[7]=TFile::Open(root_file_name_7);
  _file[8]=TFile::Open(root_file_name_8);
  _file[9]=TFile::Open(root_file_name_9);
  _file[10]=TFile::Open(root_file_name_10);
  _file[11]=TFile::Open(root_file_name_11);
  _file[12]=TFile::Open(root_file_name_12);
  _file[13]=TFile::Open(root_file_name_13);

  for(int id=1;id<=13;id++)
    {
      sprintf(histname1,"hr1_%d",id);    
      hr1[id]= new TH1D(histname1, histname1, 16800, 100001, 352001);
      hr1[id]->Sumw2(kTRUE);
      
      sprintf(histname2,"hr2_%d",id);    
      hr2[id]= new TH1D(histname2, histname2, 16800, 100001, 352001);
      hr2[id]->Sumw2(kTRUE);
      
      sprintf(histname3,"hr3_%d",id);    
      hr3[id]= new TH1D(histname3, histname3, 16800, 100001, 352001);
      hr3[id]->Sumw2(kTRUE);
      
      sprintf(histname4,"hr4_%d",id);    
      hr4[id]= new TH1D(histname4, histname4, 16800, 100001, 352001);
      hr4[id]->Sumw2(kTRUE);
      
      for(int i=1;i<=24;i++)
      {
       hrcalo1[i]= (TH1D*)(_file[id]->FindObjectAny(TString::Format("qHist1D_sig_rm_%d_0_1", i)));
       hr1[id]->Add(hrcalo1[i],1);
       hrcalo2[i]= (TH1D*)(_file[id]->FindObjectAny(TString::Format("qHist1D_sig_rm_%d_1_1", i)));
       hr2[id]->Add(hrcalo2[i],1);
       hrcalo3[i]= (TH1D*)(_file[id]->FindObjectAny(TString::Format("qHist1D_sig_rm_%d_2_1", i)));
       hr3[id]->Add(hrcalo3[i],1);
       hrcalo4[i]= (TH1D*)(_file[id]->FindObjectAny(TString::Format("qHist1D_sig_rm_%d_3_1", i)));
       hr4[id]->Add(hrcalo4[i],1);
      }
 ...
 for(int i=1;i<=13;i++)
  ...
  //hrsum= new TH1D("calo histogram sum ratio", "calosum ratio", hsum1->GetNbinsX(), 100001, 352001);
	...
	hcalo->GetXaxis()->SetTitle("time [ns]");
        ...
        fit_func7->SetParameter(3, 0.0015);
        fit_func7->SetParameter(4, 265000);
        fit_func7->SetParameter(5, 0.00233);
        fit_func7->SetParameter(6, 5.9);
       ...
       fit_func15->SetParameter(11, 0.00015);
       ...
       fit_func19->SetParameter(15, 0.0006);
       fit_func19->SetParameter(16, 95000);
       fit_func19->SetParameter(17, 0.0139);
       fit_func19->SetParameter(18, 5.5);
       ...
       fit_func23->SetParameter(20, 36500);
       fit_func23->SetParameter(21, 0.01405);
       fit_func23->SetParameter(22, 3.1);
...
;
       for(int ix=hcalo->FindBin(fit_start);ix<=cov.GetRowUpb();ix++)
	 {
       ...
       cout<<"fit parameter value is "<<fit_func23->GetParameter(20)<<endl;
       ...
       fit_func23->ReleaseParameter(12);
       fit_func23->ReleaseParameter(13);

       fit_func23->ReleaseParameter(16);
       fit_func23->ReleaseParameter(17);

       fit_func23->ReleaseParameter(20);
       fit_func23->ReleaseParameter(21);
