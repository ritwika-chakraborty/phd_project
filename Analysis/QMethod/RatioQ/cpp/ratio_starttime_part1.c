...
void ratio_starttime_part1()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   chisq_1=new TH1D("chisq_1","chisq_1",3,0,3);
     ...
     fit_func23->SetNpx(1000000);
       ...
       fit_func23->SetParameter(8, 0.34);
       fit_func23->SetParameter(9, -0.00008);
       fit_func23->SetParameter(10, -18.5);
       ...
       //fit_func23->SetParameter(16, 114000);
 ...
 for(int i=1;i<=3;i++)
  ...
  foutput=new TFile("starttime_output_avg_constmat_th_15_part1.root","new");
