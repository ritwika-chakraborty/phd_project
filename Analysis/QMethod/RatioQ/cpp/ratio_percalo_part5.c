...
void ratio_percalo_part5()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   A_5=new TH1D("A_5","A_5",4,0,4);
   blindR_5=new TH1D("blindR_5","blindR_5",4,0,4);
   phi_0_5=new TH1D("phi_0_5","phi_0_5",4,0,4);
   A_cbo_N_5=new TH1D("A_cbo_N_5","A_cbo_N_5",4,0,4);
   tau_cbo_5=new TH1D("tau_cbo_5","tau_cbo_5",4,0,4);
   omega_cbo_5=new TH1D("omega_cbo_5","omega_cbo_5",4,0,4);
   phi_cbo_N_5=new TH1D("phi_cbo_N_5","phi_cbo_N_5",4,0,4);
   A_cbo_A_5=new TH1D("A_cbo_A_5","A_cbo_A_5",4,0,4);
   phi_cbo_A_5=new TH1D("phi_cbo_A_5","phi_cbo_A_5",4,0,4);
   A_cbo_phi_5=new TH1D("A_cbo_phi_5","A_cbo_phi_5",4,0,4);
   phi_cbo_phi_5=new TH1D("phi_cbo_phi_5","phi_cbo_phi_5",4,0,4);
   A_vw_5=new TH1D("A_vw_5","A_vw_5",4,0,4);
   tau_vw_5=new TH1D("tau_vw_5","tau_vw_5",4,0,4);
   omega_vw_5=new TH1D("omega_vw_5","omega_vw_5",4,0,4);
   phi_vw_5=new TH1D("phi_vw_5","phi_vw_5",4,0,4);
   A_y_5=new TH1D("A_y_5","A_y_5",4,0,4);
   tau_y_5=new TH1D("tau_y_5","tau_y_5",4,0,4);
   omega_y_5=new TH1D("omega_y_5","omega_y_5",4,0,4);
   phi_y_5=new TH1D("phi_y_5","phi_y_5",4,0,4);
   A_2cbo_5=new TH1D("A_2cbo_5","A_2cbo_5",4,0,4);
   tau_2cbo_5=new TH1D("tau_2cbo_5","tau_2cbo_5",4,0,4);
   omega_2cbo_5=new TH1D("omega_2cbo_5","omega_2cbo_5",4,0,4);
   phi_2cbo_5=new TH1D("phi_2cbo_5","phi_2cbo_5",4,0,4);
   n_5=new TH1D("n_5","n_5",4,0,4);
   
   chisq_5=new TH1D("chisq_5","chisq_5",4,0,4);
  ...
  fit_func15= new TF1("fprec15", fprec15,  30000,  309000, 15);
	...
	hr_sum = construct_rhist_copy(h[i+16]);
	...
	hr_sum->GetXaxis()->SetTitle("time [ns]");
 	...
 	cov2.ResizeTo(hr_sum->FindBin(fit_start), hr_sum->FindBin(fit_stop), hr_sum->FindBin(fit_start), hr_sum->FindBin(fit_stop), -1);
        ...
        fit_func7->SetParameter(3, 0.016);
        fit_func7->SetParameter(4, 221400);
        fit_func7->SetParameter(5, 0.0023404);
        fit_func7->SetParameter(6, -6.38);
	...
	hr_sum->Fit("fprec7","RE","",fit_start,fit_stop);
       ...
       fit_func11->SetParameter(8, -1.7);
       fit_func11->SetParameter(9, 0.004);
       fit_func11->SetParameter(10, -5.4);
       ...
       fit_func19->SetParameter(15, 0.0012);
       fit_func19->SetParameter(16, 50000);
       fit_func19->SetParameter(17, 0.0140);
       fit_func19->SetParameter(18, -3.5);
       ...
       A_5->SetBinContent(i,fit_func19->GetParameter(0));
       blindR_5->SetBinContent(i,fit_func19->GetParameter(1));
       phi_0_5->SetBinContent(i,fit_func19->GetParameter(2));
       A_cbo_N_5->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(3)));
       tau_cbo_5->SetBinContent(i,fit_func19->GetParameter(4));
       omega_cbo_5->SetBinContent(i,fit_func19->GetParameter(5));
       phi_cbo_N_5->SetBinContent(i,fit_func19->GetParameter(6));
       A_cbo_A_5->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(7)));
       phi_cbo_A_5->SetBinContent(i,fit_func19->GetParameter(8));
       A_cbo_phi_5->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(9)));
       phi_cbo_phi_5->SetBinContent(i,fit_func19->GetParameter(10));
       //A_vw_5->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       //tau_vw_5->SetBinContent(i,fit_func19->GetParameter(12));
       //omega_vw_5->SetBinContent(i,fit_func19->GetParameter(13));
       //phi_vw_5->SetBinContent(i,fit_func19->GetParameter(14));
       A_y_5->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(15)));
       tau_y_5->SetBinContent(i,fit_func19->GetParameter(16));
       omega_y_5->SetBinContent(i,fit_func19->GetParameter(17));
       phi_y_5->SetBinContent(i,fit_func19->GetParameter(18));
       A_2cbo_5->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       tau_2cbo_5->SetBinContent(i,fit_func19->GetParameter(12));
       omega_2cbo_5->SetBinContent(i,fit_func19->GetParameter(13));
       phi_2cbo_5->SetBinContent(i,fit_func19->GetParameter(14));

     
       chisq_5->SetBinContent(i,fit_func19->GetChisquare()/fit_func19->GetNDF());
       ...
       while(phi_2cbo_5->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
       ...
       A_5->SetBinError(i,fit_func19->GetParError(0));
       blindR_5->SetBinError(i,fit_func19->GetParError(1));
       phi_0_5->SetBinError(i,fit_func19->GetParError(2));
       A_cbo_N_5->SetBinError(i,fit_func19->GetParError(3));
       tau_cbo_5->SetBinError(i,fit_func19->GetParError(4));
       omega_cbo_5->SetBinError(i,fit_func19->GetParError(5));
       phi_cbo_N_5->SetBinError(i,fit_func19->GetParError(6));
       A_cbo_A_5->SetBinError(i,fit_func19->GetParError(7));
       phi_cbo_A_5->SetBinError(i,fit_func19->GetParError(8));
       A_cbo_phi_5->SetBinError(i,fit_func19->GetParError(9));
       phi_cbo_phi_5->SetBinError(i,fit_func19->GetParError(10));
       //A_vw_5->SetBinError(i,fit_func19->GetParError(11));
       //tau_vw_5->SetBinError(i,fit_func19->GetParError(12));
       //omega_vw_5->SetBinError(i,fit_func19->GetParError(13));
       //phi_vw_5->SetBinError(i,fit_func19->GetParError(14));
       A_y_5->SetBinError(i,fit_func19->GetParError(15));
       tau_y_5->SetBinError(i,fit_func19->GetParError(16));
       omega_y_5->SetBinError(i,fit_func19->GetParError(17));
       phi_y_5->SetBinError(i,fit_func19->GetParError(18));
       A_2cbo_5->SetBinError(i,fit_func19->GetParError(11));
       tau_2cbo_5->SetBinError(i,fit_func19->GetParError(12));
       omega_2cbo_5->SetBinError(i,fit_func19->GetParError(13));
       phi_2cbo_5->SetBinError(i,fit_func19->GetParError(14));

     
       n_5->SetBinContent(i,i+16);
       m=m+1;
 ...
 for(int i=1;i<=4;i++)
  ...
  foutput=new TFile("percalo_output_part5.root","new");
