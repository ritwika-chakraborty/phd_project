...
Int_t m=0;
TH1D *chisq_6, *A_6, *blindR_6, *phi_0_6, *A_cbo_N_6, *tau_cbo_6, *omega_cbo_6, *phi_cbo_N_6, *A_cbo_A_6, *phi_cbo_A_6, *A_cbo_phi_6, *phi_cbo_phi_6, *A_vw_6, *tau_vw_6, *omega_vw_6, *phi_vw_6, *A_y_6, *tau_y_6, *omega_y_6, *phi_y_6, *A_2cbo_6, *tau_2cbo_6, *omega_2cbo_6, *phi_2cbo_6,*n_6;
Int_t countfcn=0;
Double_t ch=0;
   ...
   for (Int_t i = 0; i < (mdim)*(mdim); i++)
	...
	const Int_t ic = (i)%(mdim);
	    	...
	    	if(ir==ic-nbinshift)
	  {
	    ...
	    //   data[i]=covar;
	     data[i]=(-0.688)*sqrt(hr_sum->GetBinError(ir)*hr_sum->GetBinError(ir)*hr_sum->GetBinError(ic)*hr_sum->GetBinError(ic));
	    //    data[i]=(-2.0/3.0);
		...
		if(ir==ic+nbinshift)
	  {
	    ...
	    // data[i]=covar;
	     //  cout<<ir<<" "<<ic<<" "<<data[i]<<endl;
	      data[i]=(-0.645)*sqrt(hr_sum->GetBinError(ir)*hr_sum->GetBinError(ir)*hr_sum->GetBinError(ic)*hr_sum->GetBinError(ic));
	    //   data[i]=(-2.0/3.0);
	  }
		...
		// 	data[i]=covar/sqrt(hr_sum->GetBinError(ir)*hr_sum->GetBinError(ir)*hr_sum->GetBinError(ic)*hr_sum->GetBinError(ic));
	       	...
	       	//  data[i]=covar;
		  //	cout<<ir<<" "<<ic<<" "<<data[i]<<endl;
			data[i]=(0.178)*sqrt(hr_sum->GetBinError(ir)*hr_sum->GetBinError(ir)*hr_sum->GetBinError(ic)*hr_sum->GetBinError(ic));
		//	data[i]=(1.0/6.0);
	      }
		...
		//	data[i]=covar;
			//		cout<<ir<<" "<<ic<<" "<<data[i]<<endl;
		 	data[i]=(0.159)*sqrt(hr_sum->GetBinError(ir)*hr_sum->GetBinError(ir)*hr_sum->GetBinError(ic)*hr_sum->GetBinError(ic));
		//	data[i]=(1.0/6.0);
...
void ratio_starttime_part6()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   A_6=new TH1D("A_6","A_6",3,0,3);
   blindR_6=new TH1D("blindR_6","blindR_6",3,0,3);
   phi_0_6=new TH1D("phi_0_6","phi_0_6",3,0,3);
   A_cbo_N_6=new TH1D("A_cbo_N_6","A_cbo_N_6",3,0,3);
   tau_cbo_6=new TH1D("tau_cbo_6","tau_cbo_6",3,0,3);
   omega_cbo_6=new TH1D("omega_cbo_6","omega_cbo_6",3,0,3);
   phi_cbo_N_6=new TH1D("phi_cbo_N_6","phi_cbo_N_6",3,0,3);
   A_cbo_A_6=new TH1D("A_cbo_A_6","A_cbo_A_6",3,0,3);
   phi_cbo_A_6=new TH1D("phi_cbo_A_6","phi_cbo_A_6",3,0,3);
   A_cbo_phi_6=new TH1D("A_cbo_phi_6","A_cbo_phi_6",3,0,3);
   phi_cbo_phi_6=new TH1D("phi_cbo_phi_6","phi_cbo_phi_6",3,0,3);
   A_vw_6=new TH1D("A_vw_6","A_vw_6",3,0,3);
   tau_vw_6=new TH1D("tau_vw_6","tau_vw_6",3,0,3);
   omega_vw_6=new TH1D("omega_vw_6","omega_vw_6",3,0,3);
   phi_vw_6=new TH1D("phi_vw_6","phi_vw_6",3,0,3);
   A_y_6=new TH1D("A_y_6","A_y_6",3,0,3);
   tau_y_6=new TH1D("tau_y_6","tau_y_6",3,0,3);
   omega_y_6=new TH1D("omega_y_6","omega_y_6",3,0,3);
   phi_y_6=new TH1D("phi_y_6","phi_y_6",3,0,3);
   A_2cbo_6=new TH1D("A_2cbo_6","A_2cbo_6",3,0,3);
   tau_2cbo_6=new TH1D("tau_2cbo_6","tau_2cbo_6",3,0,3);
   omega_2cbo_6=new TH1D("omega_2cbo_6","omega_2cbo_6",3,0,3);
   phi_2cbo_6=new TH1D("phi_2cbo_6","phi_2cbo_6",3,0,3);
   n_6=new TH1D("n_6","n_6",3,0,3);
   
   chisq_6=new TH1D("chisq_6","chisq_6",3,0,3);
     ...
     fit_func23->SetNpx(1000000);
       ...
       fit_func23->SetParameter(0, 0.2292);
       fit_func23->SetParameter(1, 0.0);
       fit_func23->SetParameter(2, 2.22);
       fit_func23->SetParameter(3, 0.0024);
       //fit_func23->SetParameter(4, 264100);
       //fit_func23->SetParameter(5, 0.00234085);
       fit_func23->FixParameter(4, 243936.11);
       fit_func23->FixParameter(5, 0.0023403791);

       fit_func23->SetParameter(6, 0.44);
       fit_func23->SetParameter(7, 0.00075);
       fit_func23->SetParameter(8, 0.4);
       fit_func23->SetParameter(9, -0.000097);
       fit_func23->SetParameter(10, -18.89);
       fit_func23->SetParameter(11, 0.0024);
       //fit_func23->SetParameter(12, 30800);
       //fit_func23->SetParameter(13, 0.01404);
       fit_func23->FixParameter(12, 28629.107);
       fit_func23->FixParameter(13,  0.014037648);

       fit_func23->SetParameter(14, 2.83);
       fit_func23->SetParameter(15, 0.000263);
       //fit_func23->SetParameter(16, 129000);
       //fit_func23->SetParameter(17, 0.01393);
       fit_func23->FixParameter(16, 111541.29);
       fit_func23->FixParameter(17, 0.013931315);

       fit_func23->SetParameter(18, 5.99);
       fit_func23->SetParameter(19, 0.00014);
       //fit_func23->SetParameter(20, 130500);
       //fit_func23->SetParameter(21, 0.00469);
       fit_func23->FixParameter(20, (243936.11/2));
       fit_func23->FixParameter(21, (2*0.0023403791));

       fit_func23->SetParameter(22, 2.53);
	...
	*/ 
       ...
       A_6->SetBinContent(i,fit_func23->GetParameter(0));
       blindR_6->SetBinContent(i,fit_func23->GetParameter(1));
       phi_0_6->SetBinContent(i,fit_func23->GetParameter(2));
       A_cbo_N_6->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(3)));
       tau_cbo_6->SetBinContent(i,fit_func23->GetParameter(4));
       omega_cbo_6->SetBinContent(i,fit_func23->GetParameter(5));
       phi_cbo_N_6->SetBinContent(i,fit_func23->GetParameter(6));
       A_cbo_A_6->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(7)));
       phi_cbo_A_6->SetBinContent(i,fit_func23->GetParameter(8));
       A_cbo_phi_6->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(9)));
       phi_cbo_phi_6->SetBinContent(i,fit_func23->GetParameter(10));
       A_vw_6->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(11)));
       tau_vw_6->SetBinContent(i,fit_func23->GetParameter(12));
       omega_vw_6->SetBinContent(i,fit_func23->GetParameter(13));
       phi_vw_6->SetBinContent(i,fit_func23->GetParameter(14));
       A_y_6->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(15)));
       tau_y_6->SetBinContent(i,fit_func23->GetParameter(16));
       omega_y_6->SetBinContent(i,fit_func23->GetParameter(17));
       phi_y_6->SetBinContent(i,fit_func23->GetParameter(18));
       A_2cbo_6->SetBinContent(i,TMath::Abs(fit_func23->GetParameter(19)));
       tau_2cbo_6->SetBinContent(i,fit_func23->GetParameter(20));
       omega_2cbo_6->SetBinContent(i,fit_func23->GetParameter(21));
       phi_2cbo_6->SetBinContent(i,fit_func23->GetParameter(22));

     
       chisq_6->SetBinContent(i,fit_func23->GetChisquare()/fit_func23->GetNDF());


       while(phi_cbo_N_6->GetBinContent(i) < 0.0)
	 {
	   phi_cbo_N_6->SetBinContent(i, phi_cbo_N_6->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_cbo_A_6->GetBinContent(i) < 0.0)
	 {
	   phi_cbo_A_6->SetBinContent(i, phi_cbo_A_6->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_cbo_phi_6->GetBinContent(i) < 0.0)
	 {
	   phi_cbo_phi_6->SetBinContent(i, phi_cbo_phi_6->GetBinContent(i) + (2*(TMath::Pi())));
	 }
       
       while(phi_vw_6->GetBinContent(i) < 0.0)
	 {
	   phi_vw_6->SetBinContent(i, phi_vw_6->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_y_6->GetBinContent(i) < 0.0)
	 {
	   phi_y_6->SetBinContent(i, phi_y_6->GetBinContent(i) + (2*(TMath::Pi())));
	 }

       while(phi_2cbo_6->GetBinContent(i) < 0.0)
	 {
	   phi_2cbo_6->SetBinContent(i, phi_2cbo_6->GetBinContent(i) + (2*(TMath::Pi())));
	 }

         while(phi_cbo_N_6->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_cbo_N_6->SetBinContent(i, phi_cbo_N_6->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_cbo_A_6->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_cbo_A_6->SetBinContent(i, phi_cbo_A_6->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_cbo_phi_6->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_cbo_phi_6->SetBinContent(i, phi_cbo_phi_6->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_vw_6->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_vw_6->SetBinContent(i, phi_vw_6->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_y_6->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_y_6->SetBinContent(i, phi_y_6->GetBinContent(i) - (2*(TMath::Pi())));
	 }

       while(phi_2cbo_6->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
	   phi_2cbo_6->SetBinContent(i, phi_2cbo_6->GetBinContent(i) - (2*(TMath::Pi())));
	 }
       
       A_6->SetBinError(i,fit_func23->GetParError(0));
       blindR_6->SetBinError(i,fit_func23->GetParError(1));
       phi_0_6->SetBinError(i,fit_func23->GetParError(2));
       A_cbo_N_6->SetBinError(i,fit_func23->GetParError(3));
       tau_cbo_6->SetBinError(i,fit_func23->GetParError(4));
       omega_cbo_6->SetBinError(i,fit_func23->GetParError(5));
       phi_cbo_N_6->SetBinError(i,fit_func23->GetParError(6));
       A_cbo_A_6->SetBinError(i,fit_func23->GetParError(7));
       phi_cbo_A_6->SetBinError(i,fit_func23->GetParError(8));
       A_cbo_phi_6->SetBinError(i,fit_func23->GetParError(9));
       phi_cbo_phi_6->SetBinError(i,fit_func23->GetParError(10));
       A_vw_6->SetBinError(i,fit_func23->GetParError(11));
       tau_vw_6->SetBinError(i,fit_func23->GetParError(12));
       omega_vw_6->SetBinError(i,fit_func23->GetParError(13));
       phi_vw_6->SetBinError(i,fit_func23->GetParError(14));
       A_y_6->SetBinError(i,fit_func23->GetParError(15));
       tau_y_6->SetBinError(i,fit_func23->GetParError(16));
       omega_y_6->SetBinError(i,fit_func23->GetParError(17));
       phi_y_6->SetBinError(i,fit_func23->GetParError(18));
       A_2cbo_6->SetBinError(i,fit_func23->GetParError(19));
       tau_2cbo_6->SetBinError(i,fit_func23->GetParError(20));
       omega_2cbo_6->SetBinError(i,fit_func23->GetParError(21));
       phi_2cbo_6->SetBinError(i,fit_func23->GetParError(22));

     
       n_6->SetBinContent(i,fit_start);
       m=m+1;
 ...
 for(int i=1;i<=3;i++)
  ...
  foutput=new TFile("starttime_output_avg_constmat_th_15_part6.root","new");
