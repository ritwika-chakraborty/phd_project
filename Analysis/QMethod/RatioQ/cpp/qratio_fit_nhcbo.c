  ...
  double binwidth=h_sum->GetBinWidth(1);
   ...
   for(int ibin=1;ibin<=h_num->GetNbinsX();ibin++)
     ...
     fit_func->SetNpx(1000000);
        ...
        fit_func2= new TF1("fprec2", fprec2,  30000,  309000, 7);
	fit_func2->SetParNames("A", "Blind R", "Phi", "A_cbo", "tau_cbo", "omega_cbo", "phi_cbo");
     fit_func2->SetNpx(1000000);
     fit_func2->SetParameters(0.2, 0.0, 3.14/2, 0.002,220000,0.00234,3.5);
