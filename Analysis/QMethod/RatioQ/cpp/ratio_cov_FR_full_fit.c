 ...
 */
 ...
 //	cout<<"binwidth of hcomp_sum is "<<hcomp_sum->GetBinWidth(20)<<endl;
 //	cout<<"binwidth of h_sum is "<<ho_sum->GetBinContent(20)<<endl;
...
void ratio_cov_FR_full_fit()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   cout<<h_sum->GetBinWidth(1)<<" "<<h_sum->GetNbinsX()<<" "<<h_sum->GetBinLowEdge(1)<<" "<<(h_sum->GetBinLowEdge(h_sum->GetNbinsX())+h_sum->GetBinWidth(1))<<" "<<endl;
	...
	//cout<<"binwidth of hcomp_sum is "<<hcomp_sum->GetBinWidth(20)<<endl;
	//cout<<"binwidth of h_sum is "<<h_sum->GetBinContent(20)<<endl;
  ...
  */
   ...
   /*foutput=new TFile("4h_copy_ratio_FR.root","new");
   hr_sum->Write();
   hcov->Write();
   foutput->Close();
   */
   ...
   h_sum->Scale(0.5);
	...
	//  hr_sum->Fit("fprec7","RE","",fit_start,fit_stop);
       ...
       */
       ...
       fit_func23->SetParameter(4, 254060);
       fit_func23->SetParameter(5, 0.00234062);
       ...
       fit_func23->SetParameter(12, 138440);
       fit_func23->SetParameter(13, 0.01393);
       fit_func23->SetParameter(14, 0.273);
       fit_func23->SetParameter(15, -0.001);
       fit_func23->SetParameter(16, 34840);
       fit_func23->SetParameter(17, 0.0140369);
       fit_func23->SetParameter(18, -19.95);
       fit_func23->SetParameter(19, 0.00011);
       fit_func23->SetParameter(20, 170760);
