...
void run2_randomized_FR_fullfit()
{
  ...
  //hrsum= new TH1D("calo histogram sum ratio", "calosum ratio", hsum1->GetNbinsX(), 100001, 352001);
    ...
    else
   {
	...
	freq[1]=fit_func7->GetParameter(1);
       ...
       fit_func19->SetParameter(16, 165000);
       fit_func19->SetParameter(17, 0.01392);
       fit_func19->SetParameter(18, 0.4);
       ...
       fit_func23->SetParameter(20, 27630);
       fit_func23->SetParameter(21, 0.01404);
       ...
       fit_func27->FixParameter(24, 52000);
       fit_func27->FixParameter(25, 0.01197);
       ...
       fit_func29->FixParameter(28, 55500);
 ...
 for(int i=1;i<=1;i++)
   {
    ...
    c1=new TCanvas("c1","run2 blind R vs random seed");
    c1->Divide(2,2);
    c1->cd(1);
    ...
    c4=new TCanvas("c4","run2 cbo vs random seed");
    c4->Divide(2,2);
    c4->cd(1);
    ...
    c6=new TCanvas("c6","run2 A,phi,cbo vs random seed");
    c6->Divide(2,2);
    c6->cd(1);
    ...
    gr16->Draw("ap");
     ...
     c7=new TCanvas("c7","run2 2cbo vs random seed");
     c7->Divide(2,2);
    c7->cd(1);
    ...
    c8=new TCanvas("c8","run 2 vw vs fit start time");
    c8->Divide(2,2);
    c8->cd(1);
    ...
    c9=new TCanvas("c9","run2 y vs random seed");
    c9->Divide(2,2);
    c9->cd(1);
