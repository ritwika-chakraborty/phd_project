...
void ratio_percalo_part6()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   A_6=new TH1D("A_6","A_6",4,0,4);
   blindR_6=new TH1D("blindR_6","blindR_6",4,0,4);
   phi_0_6=new TH1D("phi_0_6","phi_0_6",4,0,4);
   A_cbo_N_6=new TH1D("A_cbo_N_6","A_cbo_N_6",4,0,4);
   tau_cbo_6=new TH1D("tau_cbo_6","tau_cbo_6",4,0,4);
   omega_cbo_6=new TH1D("omega_cbo_6","omega_cbo_6",4,0,4);
   phi_cbo_N_6=new TH1D("phi_cbo_N_6","phi_cbo_N_6",4,0,4);
   A_cbo_A_6=new TH1D("A_cbo_A_6","A_cbo_A_6",4,0,4);
   phi_cbo_A_6=new TH1D("phi_cbo_A_6","phi_cbo_A_6",4,0,4);
   A_cbo_phi_6=new TH1D("A_cbo_phi_6","A_cbo_phi_6",4,0,4);
   phi_cbo_phi_6=new TH1D("phi_cbo_phi_6","phi_cbo_phi_6",4,0,4);
   A_vw_6=new TH1D("A_vw_6","A_vw_6",4,0,4);
   tau_vw_6=new TH1D("tau_vw_6","tau_vw_6",4,0,4);
   omega_vw_6=new TH1D("omega_vw_6","omega_vw_6",4,0,4);
   phi_vw_6=new TH1D("phi_vw_6","phi_vw_6",4,0,4);
   A_y_6=new TH1D("A_y_6","A_y_6",4,0,4);
   tau_y_6=new TH1D("tau_y_6","tau_y_6",4,0,4);
   omega_y_6=new TH1D("omega_y_6","omega_y_6",4,0,4);
   phi_y_6=new TH1D("phi_y_6","phi_y_6",4,0,4);
   A_2cbo_6=new TH1D("A_2cbo_6","A_2cbo_6",4,0,4);
   tau_2cbo_6=new TH1D("tau_2cbo_6","tau_2cbo_6",4,0,4);
   omega_2cbo_6=new TH1D("omega_2cbo_6","omega_2cbo_6",4,0,4);
   phi_2cbo_6=new TH1D("phi_2cbo_6","phi_2cbo_6",4,0,4);
   n_6=new TH1D("n_6","n_6",4,0,4);
   
   chisq_6=new TH1D("chisq_6","chisq_6",4,0,4);
  ...
  fit_func15= new TF1("fprec15", fprec15,  30000,  309000, 15);
	...
	hr_sum = construct_rhist_copy(h[i+20]);
	...
	hr_sum->GetXaxis()->SetTitle("time [ns]");
 	...
 	cov2.ResizeTo(hr_sum->FindBin(fit_start), hr_sum->FindBin(fit_stop), hr_sum->FindBin(fit_start), hr_sum->FindBin(fit_stop), -1);
       ...
       fit_func3->SetParameters(0.22, 0.0, 2.22);
        ...
        fit_func7->SetParameter(3, 0.0208);
        fit_func7->SetParameter(4, 245000);
        fit_func7->SetParameter(5, 0.0023406);
        fit_func7->SetParameter(6, -6.99);
	...
	hr_sum->Fit("fprec7","RE","",fit_start,fit_stop);
       ...
       fit_func11->SetParameter(7, 0.011);
       fit_func11->SetParameter(8, -2.58);
       fit_func11->SetParameter(9, 0.003);
       fit_func11->SetParameter(10, -6.47);
       ...
       fit_func19->SetParameter(16, 35300);
       fit_func19->SetParameter(17, 0.0140);
       fit_func19->SetParameter(18, -4.3);
       ...
       A_6->SetBinContent(i,fit_func19->GetParameter(0));
       blindR_6->SetBinContent(i,fit_func19->GetParameter(1));
       phi_0_6->SetBinContent(i,fit_func19->GetParameter(2));
       A_cbo_N_6->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(3)));
       tau_cbo_6->SetBinContent(i,fit_func19->GetParameter(4));
       omega_cbo_6->SetBinContent(i,fit_func19->GetParameter(5));
       phi_cbo_N_6->SetBinContent(i,fit_func19->GetParameter(6));
       A_cbo_A_6->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(7)));
       phi_cbo_A_6->SetBinContent(i,fit_func19->GetParameter(8));
       A_cbo_phi_6->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(9)));
       phi_cbo_phi_6->SetBinContent(i,fit_func19->GetParameter(10));
       // A_vw_6->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       //tau_vw_6->SetBinContent(i,fit_func19->GetParameter(12));
       //omega_vw_6->SetBinContent(i,fit_func19->GetParameter(13));
       //phi_vw_6->SetBinContent(i,fit_func19->GetParameter(14));
       A_y_6->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(15)));
       tau_y_6->SetBinContent(i,fit_func19->GetParameter(16));
       omega_y_6->SetBinContent(i,fit_func19->GetParameter(17));
       phi_y_6->SetBinContent(i,fit_func19->GetParameter(18));
       A_2cbo_6->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       tau_2cbo_6->SetBinContent(i,fit_func19->GetParameter(12));
       omega_2cbo_6->SetBinContent(i,fit_func19->GetParameter(13));
       phi_2cbo_6->SetBinContent(i,fit_func19->GetParameter(14));

     
       chisq_6->SetBinContent(i,fit_func19->GetChisquare()/fit_func19->GetNDF());
       ...
       while(phi_2cbo_6->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
       ...
       A_6->SetBinError(i,fit_func19->GetParError(0));
       blindR_6->SetBinError(i,fit_func19->GetParError(1));
       phi_0_6->SetBinError(i,fit_func19->GetParError(2));
       A_cbo_N_6->SetBinError(i,fit_func19->GetParError(3));
       tau_cbo_6->SetBinError(i,fit_func19->GetParError(4));
       omega_cbo_6->SetBinError(i,fit_func19->GetParError(5));
       phi_cbo_N_6->SetBinError(i,fit_func19->GetParError(6));
       A_cbo_A_6->SetBinError(i,fit_func19->GetParError(7));
       phi_cbo_A_6->SetBinError(i,fit_func19->GetParError(8));
       A_cbo_phi_6->SetBinError(i,fit_func19->GetParError(9));
       phi_cbo_phi_6->SetBinError(i,fit_func19->GetParError(10));
       // A_vw_6->SetBinError(i,fit_func19->GetParError(11));
       //tau_vw_6->SetBinError(i,fit_func19->GetParError(12));
       //omega_vw_6->SetBinError(i,fit_func19->GetParError(13));
       //phi_vw_6->SetBinError(i,fit_func19->GetParError(14));
       A_y_6->SetBinError(i,fit_func19->GetParError(15));
       tau_y_6->SetBinError(i,fit_func19->GetParError(16));
       omega_y_6->SetBinError(i,fit_func19->GetParError(17));
       phi_y_6->SetBinError(i,fit_func19->GetParError(18));
       A_2cbo_6->SetBinError(i,fit_func19->GetParError(11));
       tau_2cbo_6->SetBinError(i,fit_func19->GetParError(12));
       omega_2cbo_6->SetBinError(i,fit_func19->GetParError(13));
       phi_2cbo_6->SetBinError(i,fit_func19->GetParError(14));

     
       n_6->SetBinContent(i,i+20);
       m=m+1;
 ...
 for(int i=1;i<=4;i++)
  ...
  foutput=new TFile("percalo_output_part6.root","new");
