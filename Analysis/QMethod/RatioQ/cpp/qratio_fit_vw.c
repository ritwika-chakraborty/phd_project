  ...
  double binwidth=h_sum->GetBinWidth(1);
   ...
   for(int ibin=1;ibin<=h_num->GetNbinsX();ibin++)
     ...
     fit_func->SetNpx(1000000);
        ...
        fit_func2= new TF1("fprec2", fprec2,  30000,  309000, 15);
	...
	fit_func2->SetParName(14,"phi_vw");
     ...
     fit_func2->SetParameters(0.24, 0.0, 2.19, 0.003,228000,0.00234,0.23);
     fit_func2->SetParameter(7,-0.00046);
     fit_func2->SetParameter(8,5.87);
     fit_func2->SetParameter(9,0.000188);
     fit_func2->SetParameter(10,-1.6);
     fit_func2->SetParameter(11,0.014);
     fit_func2->SetParameter(12,28000);
