...
TDirectory *dir[25];
TH1D *h[25],*qHist_1D[25],*h_sum, *h1, *h2, *hp, *hm, *h_ratio, *h_num, *h_deno, *hcalo, *hfit, *hr[25], *h_res_1[50], *hr_sum, *hrc_sum;
...
TH1 *hfft_1[50];
TF1 *fit_func3, *fit_func7, *fit_func11, *fit_func15, *fit_func19, *fit_func23, *fit_func19o;
...
void ratio_percalo_part1()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   A_1=new TH1D("A_1","A_1",4,0,4);
   blindR_1=new TH1D("blindR_1","blindR_1",4,0,4);
   phi_0_1=new TH1D("phi_0_1","phi_0_1",4,0,4);
   A_cbo_N_1=new TH1D("A_cbo_N_1","A_cbo_N_1",4,0,4);
   tau_cbo_1=new TH1D("tau_cbo_1","tau_cbo_1",4,0,4);
   omega_cbo_1=new TH1D("omega_cbo_1","omega_cbo_1",4,0,4);
   phi_cbo_N_1=new TH1D("phi_cbo_N_1","phi_cbo_N_1",4,0,4);
   A_cbo_A_1=new TH1D("A_cbo_A_1","A_cbo_A_1",4,0,4);
   phi_cbo_A_1=new TH1D("phi_cbo_A_1","phi_cbo_A_1",4,0,4);
   A_cbo_phi_1=new TH1D("A_cbo_phi_1","A_cbo_phi_1",4,0,4);
   phi_cbo_phi_1=new TH1D("phi_cbo_phi_1","phi_cbo_phi_1",4,0,4);
   A_vw_1=new TH1D("A_vw_1","A_vw_1",4,0,4);
   tau_vw_1=new TH1D("tau_vw_1","tau_vw_1",4,0,4);
   omega_vw_1=new TH1D("omega_vw_1","omega_vw_1",4,0,4);
   phi_vw_1=new TH1D("phi_vw_1","phi_vw_1",4,0,4);
   A_y_1=new TH1D("A_y_1","A_y_1",4,0,4);
   tau_y_1=new TH1D("tau_y_1","tau_y_1",4,0,4);
   omega_y_1=new TH1D("omega_y_1","omega_y_1",4,0,4);
   phi_y_1=new TH1D("phi_y_1","phi_y_1",4,0,4);
   A_2cbo_1=new TH1D("A_2cbo_1","A_2cbo_1",4,0,4);
   tau_2cbo_1=new TH1D("tau_2cbo_1","tau_2cbo_1",4,0,4);
   omega_2cbo_1=new TH1D("omega_2cbo_1","omega_2cbo_1",4,0,4);
   phi_2cbo_1=new TH1D("phi_2cbo_1","phi_2cbo_1",4,0,4);
   n_1=new TH1D("n_1","n_1",4,0,4);
   
   chisq_1=new TH1D("chisq_1","chisq_1",4,0,4);
 ...
 */
       ...
       fit_func23->SetParameter(0, 0.221893);
       fit_func23->SetParameter(1, 0.0);
       fit_func23->SetParameter(2, 2.21432);
       fit_func23->SetParameter(3, 0.0201646);
       fit_func23->FixParameter(4, 243936);
       fit_func23->FixParameter(5, 0.00234038);
       fit_func23->SetParameter(6, 4.18916);
       fit_func23->SetParameter(7, 0.0215540);
       fit_func23->SetParameter(8, 2.19656);
       fit_func23->SetParameter(9, 0.00292651);
       fit_func23->SetParameter(10, -1.42408);
       fit_func23->SetParameter(11, 0.000780359);
       fit_func23->FixParameter(12, 121968);
       fit_func23->FixParameter(13, 0.00468076);
       fit_func23->SetParameter(14, 0.83207);
       fit_func23->SetParameter(15, 0.00220962);
       fit_func23->FixParameter(16, 28629);
       fit_func23->FixParameter(17, 0.0140376);
       fit_func23->SetParameter(18, -3.52647);
       fit_func23->SetParameter(19, 0.00020512);
       fit_func23->FixParameter(20, 111541);
       fit_func23->FixParameter(21, 0.01393131);
       fit_func23->SetParameter(22, 1.99);

  


       /*   fit_func19->SetParameter(0, 0.221894);
       fit_func19->SetParameter(1, 0.0);
       fit_func19->SetParameter(2, 2.21435);
       fit_func19->SetParameter(3, 0.0202719);
       fit_func19->SetParameter(4, 240415);
       fit_func19->SetParameter(5, 0.00234070);
       fit_func19->SetParameter(6, 4.16596);
       fit_func19->SetParameter(7, 0.0216859);
       fit_func19->SetParameter(8, 2.17419);
       fit_func19->SetParameter(9, 0.00292955);
       fit_func19->SetParameter(10, -1.44163);
       fit_func19->SetParameter(11, 0.000480679);
       fit_func19->SetParameter(12, 1329600);
       fit_func19->SetParameter(13, 0.00468281);
       fit_func19->SetParameter(14, 0.672380);
       fit_func19->SetParameter(15, 0.00180498);
       fit_func19->SetParameter(16, 34553.5);
       fit_func19->SetParameter(17, 0.0140153);
       fit_func19->SetParameter(18, -2.42943);
       */ 
       /*  fit_func15->SetParameter(0, 0.22189);
       fit_func15->SetParameter(1, 0.0);
       fit_func15->SetParameter(2, 2.2143);
       fit_func15->SetParameter(3, 0.0202745);
       fit_func15->SetParameter(4, 240349);
       fit_func15->SetParameter(5, 0.0023407);
       fit_func15->SetParameter(6, 4.166);
       fit_func15->SetParameter(7, 0.021689);
       fit_func15->SetParameter(8, 2.17428);
       fit_func15->SetParameter(9, 0.00292328);
       fit_func15->SetParameter(10,-1.44115);
       fit_func15->SetParameter(11, 0.000479872);
       fit_func15->SetParameter(12, 1348920);
       fit_func15->SetParameter(13, 0.0046828);
       fit_func15->SetParameter(14, 0.671414);
       */

       /*    fit_func11->SetParameter(0, 0.22189);
       fit_func11->SetParameter(1, 0.0);
       fit_func11->SetParameter(2, 2.2143);
       fit_func11->SetParameter(3, 0.0202745);
       fit_func11->SetParameter(4, 240349);
       fit_func11->SetParameter(5, 0.0023407);
       fit_func11->SetParameter(6, 4.166);
       fit_func11->SetParameter(7, 0.021689);
       fit_func11->SetParameter(8, 2.17428);
       fit_func11->SetParameter(9, 0.00292328);
       fit_func11->SetParameter(10,-1.44115);
       
       
       fit_func7->SetParameter(0, 0.22189);
       fit_func7->SetParameter(1, 0.0);
       fit_func7->SetParameter(2, 2.2143);
       fit_func7->SetParameter(3, 0.0202745);
       fit_func7->SetParameter(4, 240349);
       fit_func7->SetParameter(5, 0.0023407);
       fit_func7->SetParameter(6, 4.166);
       
       fit_func3->SetParameter(0, 0.22189);
       fit_func3->SetParameter(1, 0.0);
       fit_func3->SetParameter(2, 2.2143);
       */

       hr_sum->Fit(fit_func23,"RUE","",fit_start,fit_stop);
       ...
       A_1->SetBinContent(i,fit_func19->GetParameter(0));
       blindR_1->SetBinContent(i,fit_func19->GetParameter(1));
       phi_0_1->SetBinContent(i,fit_func19->GetParameter(2));
       A_cbo_N_1->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(3)));
       tau_cbo_1->SetBinContent(i,fit_func19->GetParameter(4));
       omega_cbo_1->SetBinContent(i,fit_func19->GetParameter(5));
       phi_cbo_N_1->SetBinContent(i,fit_func19->GetParameter(6));
       A_cbo_A_1->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(7)));
       phi_cbo_A_1->SetBinContent(i,fit_func19->GetParameter(8));
       A_cbo_phi_1->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(9)));
       phi_cbo_phi_1->SetBinContent(i,fit_func19->GetParameter(10));
       //  A_vw_1->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       //tau_vw_1->SetBinContent(i,fit_func19->GetParameter(12));
       //omega_vw_1->SetBinContent(i,fit_func19->GetParameter(13));
       //phi_vw_1->SetBinContent(i,fit_func19->GetParameter(14));
       A_y_1->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(15)));
       tau_y_1->SetBinContent(i,fit_func19->GetParameter(16));
       omega_y_1->SetBinContent(i,fit_func19->GetParameter(17));
       phi_y_1->SetBinContent(i,fit_func19->GetParameter(18));
       A_2cbo_1->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       tau_2cbo_1->SetBinContent(i,fit_func19->GetParameter(12));
       omega_2cbo_1->SetBinContent(i,fit_func19->GetParameter(13));
       phi_2cbo_1->SetBinContent(i,fit_func19->GetParameter(14));

     
       chisq_1->SetBinContent(i,fit_func19->GetChisquare()/fit_func19->GetNDF());
       ...
       while(phi_2cbo_1->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
       ...
       A_1->SetBinError(i,fit_func19->GetParError(0));
       blindR_1->SetBinError(i,fit_func19->GetParError(1));
       phi_0_1->SetBinError(i,fit_func19->GetParError(2));
       A_cbo_N_1->SetBinError(i,fit_func19->GetParError(3));
       tau_cbo_1->SetBinError(i,fit_func19->GetParError(4));
       omega_cbo_1->SetBinError(i,fit_func19->GetParError(5));
       phi_cbo_N_1->SetBinError(i,fit_func19->GetParError(6));
       A_cbo_A_1->SetBinError(i,fit_func19->GetParError(7));
       phi_cbo_A_1->SetBinError(i,fit_func19->GetParError(8));
       A_cbo_phi_1->SetBinError(i,fit_func19->GetParError(9));
       phi_cbo_phi_1->SetBinError(i,fit_func19->GetParError(10));
       // A_vw_1->SetBinError(i,fit_func19->GetParError(11));
       //tau_vw_1->SetBinError(i,fit_func19->GetParError(12));
       //omega_vw_1->SetBinError(i,fit_func19->GetParError(13));
       //phi_vw_1->SetBinError(i,fit_func19->GetParError(14));
       A_y_1->SetBinError(i,fit_func19->GetParError(15));
       tau_y_1->SetBinError(i,fit_func19->GetParError(16));
       omega_y_1->SetBinError(i,fit_func19->GetParError(17));
       phi_y_1->SetBinError(i,fit_func19->GetParError(18));
       A_2cbo_1->SetBinError(i,fit_func19->GetParError(11));
       tau_2cbo_1->SetBinError(i,fit_func19->GetParError(12));
       omega_2cbo_1->SetBinError(i,fit_func19->GetParError(13));
       phi_2cbo_1->SetBinError(i,fit_func19->GetParError(14));

     
       n_1->SetBinContent(i,i);
       m=m+1;
 ...
 return;
   foutput=new TFile("percalo_output_part1a.root","new");
