...
//char root_file_name[128] = "run3O_thresh300.root";
...
void chi2(Int_t &npar, Double_t *gin, Double_t &f, Double_t *par, Int_t inf)
{
  ...
  f = 0;
  if (dbg) printf("par[0] %f, par[1] %f\n", par[0], par[1]);

  double chi2 = 0.;
  Double_t xi, yi, ei, fi;

  int il, ih;
  il = hr_sum->FindBin(fit_start);
  ih = hr_sum->FindBin(fit_stop);
  int nbfit = ih - il + 1;

  resvec.ResizeTo(nbfit);
  fncvec.ResizeTo(nbfit);
  dtavec.ResizeTo(nbfit);
  for (int i = il; i <= ih; i++) {

    xi = hr_sum->GetBinCenter(i);
    yi = hr_sum->GetBinContent(i);
    ei = hr_sum->GetBinError(i); // get uncertainty sigma                                                                                                                                                                                                                  

    fi = fuser->EvalPar( &xi, par);
    dtavec(i-il) = yi;
    fncvec(i-il) = fi;
    resvec(i-il) = ( yi - fi ) / ei;
  }
  ...
  ok = svd.Decompose();
  if (!ok) {
    std::cout << "SVD Decomp failed" << std::endl;
    return -1;
  }

  TVectorD x = svd.Solve(resvec, ok);
  if (!ok) {
  ...
  if (dbg) printf("x %f, y %f +/- %f, f %f, chi2 %f\n", xi, yi, yi, fi, chi2);
  fcn_chi2 = chi2;
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   cout<<h_sum->GetBinWidth(1)<<" "<<h_sum->GetNbinsX()<<" "<<h_sum->GetBinLowEdge(1)<<" "<<(h_sum->GetBinLowEdge(h_sum->GetNbinsX())+h_sum->GetBinWidth(1))<<" "<<endl;
    ...
    hlm->SetName("hlm");
     ...
     fit_func11->SetParName(7,"A_cbo_A");
     fit_func11->SetParName(8,"phi_cbo_A");
     fit_func11->SetParName(9,"A_cbo_phi");
     fit_func11->SetParName(10,"phi_cbo_phi");
     ...
     fit_func15->SetParName(7,"A_cbo_A");
     fit_func15->SetParName(8,"phi_cbo_A");
     fit_func15->SetParName(9,"A_cbo_phi");
     fit_func15->SetParName(10,"phi_cbo_phi");
     ...
     fit_func19->SetParName(7,"A_cbo_A");
     fit_func19->SetParName(8,"phi_cbo_A");
     fit_func19->SetParName(9,"A_cbo_phi");
     fit_func19->SetParName(10,"phi_cbo_phi");
  ...
  */
   ...
   */
   ...
   //  hr_sum->Fit("fprec3","RE","",fit_start,fit_stop);
	...
	//   hr_sum->Fit("fprec7","RUE","",fit_start,fit_stop);
	...
	*/
       ...
       fit_func11->SetParameter(2, 2.22);
       fit_func11->SetParameter(3, 0.0025);
       fit_func11->SetParameter(4, 235000);
       fit_func11->SetParameter(5, 0.0023405);
       fit_func11->SetParameter(6, 0.48);
       ...
       fit_func15->SetParameter(2, 2.21);
       fit_func15->SetParameter(3, 0.0025);
       fit_func15->SetParameter(4, 235000);
       fit_func15->SetParameter(5, 0.0023404);
       fit_func15->SetParameter(6, 0.48);
       fit_func15->FixParameter(7, 0.0);
       fit_func15->FixParameter(8, 0.0);
       fit_func15->FixParameter(9, 0.0);
       fit_func15->FixParameter(10,0.0);
       // fit_func15->SetParameter(11, 0.008);
       fit_func15->FixParameter(11, 0.0000000);
       //fit_func15->SetParameter(12, 17400);
       fit_func15->FixParameter(12,1.0e+16);
       // fit_func15->SetParameter(13, 0.01403);
       fit_func15->FixParameter(13,0);
       // fit_func15->SetParameter(14, 3);
       fit_func15->FixParameter(14,0);
       ...
       fit_func19->SetParameter(3, 0.0025);
       fit_func19->SetParameter(4, 235000);
       fit_func19->SetParameter(5, 0.0023405);
       fit_func19->SetParameter(6, 0.48);
       ...
       */
       ...
       // Run 3 parameters   
          fit_func19->SetParameter(0, 0.2264);
       fit_func19->SetParameter(1, 0.0);
       fit_func19->SetParameter(2, 2.235);
       fit_func19->SetParameter(3, 0.001);
       fit_func19->SetParameter(4, 220000);
       fit_func19->SetParameter(5, 0.002331);
       fit_func19->SetParameter(6, 0.38);
       fit_func19->SetParameter(7, -0.00037);
       fit_func19->SetParameter(8, -1.9);
       fit_func19->SetParameter(9, -0.0002);
       fit_func19->SetParameter(10, -20.9);
       fit_func19->SetParameter(11, 0.0036);
       fit_func19->SetParameter(12, 26644);
       fit_func19->SetParameter(13, 0.01405);
       fit_func19->SetParameter(14, 4.9);
       fit_func19->SetParameter(15, -0.0005);
       fit_func19->SetParameter(16, 75000);
       fit_func19->SetParameter(17, 0.01388);
       ...
       */
       ...
       fit_func23->SetParameter(4, 234000);
       fit_func23->SetParameter(5, 0.0023405);
       fit_func23->SetParameter(6, 0.48);
       fit_func23->SetParameter(7, 0.0007);
       fit_func23->SetParameter(8, 0.37);
       fit_func23->SetParameter(9, -0.00007);
       fit_func23->SetParameter(10, -21.0);
       fit_func23->SetParameter(11, 0.003);
       fit_func23->SetParameter(12, 29030);
       fit_func23->SetParameter(13, 0.014036);
       fit_func23->SetParameter(14, 3.0);
       fit_func23->SetParameter(15, 0.0003);
       fit_func23->SetParameter(16, 112000);
       fit_func23->SetParameter(17, 0.013931);
       fit_func23->SetParameter(18, 6.16);
       fit_func23->SetParameter(19, 0.00011);
       fit_func23->SetParameter(20, 164000);
       fit_func23->SetParameter(21, 0.004691);
