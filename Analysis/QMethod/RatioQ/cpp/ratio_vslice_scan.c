...
void ratio_vslice_scan()
{
  ...
  hlm->SetName("hlm");
	...
	hr[i]->GetXaxis()->SetTitle("time [ns]");
        ...
        fit_func7->SetParameter(4, 200000);
       ...
       fit_func11->SetParameter(7, 0.001);
       fit_func11->SetParameter(8, 2.1);
       fit_func11->SetParameter(9, 0.0003);
       fit_func11->SetParameter(10, -0.3);
       ...
       fit_func15->SetParameter(11, 0.002);
       fit_func15->SetParameter(12, 30000);
       fit_func15->SetParameter(13, 0.01404);
       fit_func15->SetParameter(14, 2.6);
       ...
       fit_func19->SetParameter(15, 0.0008);
       fit_func19->SetParameter(16, 160000);
       fit_func19->SetParameter(17, 0.01392);
       fit_func19->SetParameter(18, 6);

      
       hr[i]->Fit("fprec19","RE","",fit_start,fit_stop);
       blindR[m]=fit_func19->GetParameter(2);
       //blindR[m]=fit_func19->GetChisquare()/fit_func19->GetNDF();
       dblindR[m]=fit_func19->GetParError(2);
       n[m]=i;
       m=m+1;
  ...
  c2 = new TCanvas("c2","vslice residuals");
  c2->Divide(1,9);
  c3 = new TCanvas("c3","vslice fft");
  c3->Divide(1,9);
 ...
 for(int i=1;i<=9;i++)
   {
    ...
    c1=new TCanvas("c1","phase vs vertical slice number");
    gr1=new TGraphErrors(m,n,blindR,0,dblindR);
    gr1->SetTitle("g-2 phase vs vertical slice");
    gr1->GetXaxis()->SetTitle("vertical slice #");
