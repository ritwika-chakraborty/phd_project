...
void run3_ratio_starttime_extended_part5()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   chisq_5=new TH1D("chisq_5","chisq_5",3,0,3);
     ...
     fit_func23->SetNpx(1000000);
       ...
       fit_func23->SetParameter(3, -0.00115);
       //fit_func23->SetParameter(4, 231100);
       ...
       fit_func23->SetParameter(7, 0.000212);
       fit_func23->SetParameter(8, 47.96);
       fit_func23->SetParameter(9, 0.000138);
       fit_func23->SetParameter(10, 39.82);
       fit_func23->SetParameter(11, 0.0019);
       //fit_func23->SetParameter(12, 35497);
       //fit_func23->SetParameter(13, 0.01405);
       fit_func23->FixParameter(12, 22688.5);
       fit_func23->FixParameter(13,  0.0140631);
       fit_func23->SetParameter(14, 5.48);
       fit_func23->SetParameter(15, -0.00082);
       //fit_func23->SetParameter(16, 64699);
       //fit_func23->SetParameter(17, 0.013901);
       fit_func23->FixParameter(16, 74647.8);
       fit_func23->FixParameter(17, 0.0138950);
       fit_func23->SetParameter(18, -3.38);
       fit_func23->SetParameter(19, -0.000049);
       fit_func23->FixParameter(20, 95639);
       fit_func23->FixParameter(21, 0.004662);
       fit_func23->SetParameter(22, -0.46);
 ...
 for(int i=1;i<=3;i++)
  ...
  foutput=new TFile("run3_starttime_output_corr_fixed_extended_part5.root","new");
