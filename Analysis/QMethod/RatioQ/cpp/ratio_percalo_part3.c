...
void ratio_percalo_part3()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   A_3=new TH1D("A_3","A_3",4,0,4);
   blindR_3=new TH1D("blindR_3","blindR_3",4,0,4);
   phi_0_3=new TH1D("phi_0_3","phi_0_3",4,0,4);
   A_cbo_N_3=new TH1D("A_cbo_N_3","A_cbo_N_3",4,0,4);
   tau_cbo_3=new TH1D("tau_cbo_3","tau_cbo_3",4,0,4);
   omega_cbo_3=new TH1D("omega_cbo_3","omega_cbo_3",4,0,4);
   phi_cbo_N_3=new TH1D("phi_cbo_N_3","phi_cbo_N_3",4,0,4);
   A_cbo_A_3=new TH1D("A_cbo_A_3","A_cbo_A_3",4,0,4);
   phi_cbo_A_3=new TH1D("phi_cbo_A_3","phi_cbo_A_3",4,0,4);
   A_cbo_phi_3=new TH1D("A_cbo_phi_3","A_cbo_phi_3",4,0,4);
   phi_cbo_phi_3=new TH1D("phi_cbo_phi_3","phi_cbo_phi_3",4,0,4);
   A_vw_3=new TH1D("A_vw_3","A_vw_3",4,0,4);
   tau_vw_3=new TH1D("tau_vw_3","tau_vw_3",4,0,4);
   omega_vw_3=new TH1D("omega_vw_3","omega_vw_3",4,0,4);
   phi_vw_3=new TH1D("phi_vw_3","phi_vw_3",4,0,4);
   A_y_3=new TH1D("A_y_3","A_y_3",4,0,4);
   tau_y_3=new TH1D("tau_y_3","tau_y_3",4,0,4);
   omega_y_3=new TH1D("omega_y_3","omega_y_3",4,0,4);
   phi_y_3=new TH1D("phi_y_3","phi_y_3",4,0,4);
   A_2cbo_3=new TH1D("A_2cbo_3","A_2cbo_3",4,0,4);
   tau_2cbo_3=new TH1D("tau_2cbo_3","tau_2cbo_3",4,0,4);
   omega_2cbo_3=new TH1D("omega_2cbo_3","omega_2cbo_3",4,0,4);
   phi_2cbo_3=new TH1D("phi_2cbo_3","phi_2cbo_3",4,0,4);
   n_3=new TH1D("n_3","n_3",4,0,4);
   
   chisq_3=new TH1D("chisq_3","chisq_3",4,0,4);
	...
	hr_sum = construct_rhist_copy(h[i+8]);
	...
	hr_sum->GetXaxis()->SetTitle("time [ns]");
 	...
 	cov2.ResizeTo(hr_sum->FindBin(fit_start), hr_sum->FindBin(fit_stop), hr_sum->FindBin(fit_start), hr_sum->FindBin(fit_stop), -1);
        ...
        fit_func7->SetParameter(3, 0.0157);
        fit_func7->SetParameter(4, 225200);
        fit_func7->SetParameter(5, 0.0023404);
        fit_func7->SetParameter(6, 1.76);
	...
	hr_sum->Fit("fprec7","RE","",fit_start,fit_stop);
       ...
       fit_func11->SetParameter(7, 0.025);
       fit_func11->SetParameter(8, 0.34);
       fit_func11->SetParameter(9, 0.0042);
       fit_func11->SetParameter(10, -3.46);
       ...
       A_3->SetBinContent(i,fit_func19->GetParameter(0));
       blindR_3->SetBinContent(i,fit_func19->GetParameter(1));
       phi_0_3->SetBinContent(i,fit_func19->GetParameter(2));
       A_cbo_N_3->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(3)));
       tau_cbo_3->SetBinContent(i,fit_func19->GetParameter(4));
       omega_cbo_3->SetBinContent(i,fit_func19->GetParameter(5));
       phi_cbo_N_3->SetBinContent(i,fit_func19->GetParameter(6));
       A_cbo_A_3->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(7)));
       phi_cbo_A_3->SetBinContent(i,fit_func19->GetParameter(8));
       A_cbo_phi_3->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(9)));
       phi_cbo_phi_3->SetBinContent(i,fit_func19->GetParameter(10));
       //A_vw_3->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       //tau_vw_3->SetBinContent(i,fit_func19->GetParameter(12));
       //omega_vw_3->SetBinContent(i,fit_func19->GetParameter(13));
       //phi_vw_3->SetBinContent(i,fit_func19->GetParameter(14));
       A_y_3->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(15)));
       tau_y_3->SetBinContent(i,fit_func19->GetParameter(16));
       omega_y_3->SetBinContent(i,fit_func19->GetParameter(17));
       phi_y_3->SetBinContent(i,fit_func19->GetParameter(18));
       A_2cbo_3->SetBinContent(i,TMath::Abs(fit_func19->GetParameter(11)));
       tau_2cbo_3->SetBinContent(i,fit_func19->GetParameter(12));
       omega_2cbo_3->SetBinContent(i,fit_func19->GetParameter(13));
       phi_2cbo_3->SetBinContent(i,fit_func19->GetParameter(14));

     
       chisq_3->SetBinContent(i,fit_func19->GetChisquare()/fit_func19->GetNDF());
       ...
       while(phi_2cbo_3->GetBinContent(i) >  (2*(TMath::Pi())))
	 {
       ...
       A_3->SetBinError(i,fit_func19->GetParError(0));
       blindR_3->SetBinError(i,fit_func19->GetParError(1));
       phi_0_3->SetBinError(i,fit_func19->GetParError(2));
       A_cbo_N_3->SetBinError(i,fit_func19->GetParError(3));
       tau_cbo_3->SetBinError(i,fit_func19->GetParError(4));
       omega_cbo_3->SetBinError(i,fit_func19->GetParError(5));
       phi_cbo_N_3->SetBinError(i,fit_func19->GetParError(6));
       A_cbo_A_3->SetBinError(i,fit_func19->GetParError(7));
       phi_cbo_A_3->SetBinError(i,fit_func19->GetParError(8));
       A_cbo_phi_3->SetBinError(i,fit_func19->GetParError(9));
       phi_cbo_phi_3->SetBinError(i,fit_func19->GetParError(10));
       // A_vw_3->SetBinError(i,fit_func19->GetParError(11));
       //tau_vw_3->SetBinError(i,fit_func19->GetParError(12));
       //omega_vw_3->SetBinError(i,fit_func19->GetParError(13));
       //phi_vw_3->SetBinError(i,fit_func19->GetParError(14));
       A_y_3->SetBinError(i,fit_func19->GetParError(15));
       tau_y_3->SetBinError(i,fit_func19->GetParError(16));
       omega_y_3->SetBinError(i,fit_func19->GetParError(17));
       phi_y_3->SetBinError(i,fit_func19->GetParError(18));
       A_2cbo_3->SetBinError(i,fit_func19->GetParError(11));
       tau_2cbo_3->SetBinError(i,fit_func19->GetParError(12));
       omega_2cbo_3->SetBinError(i,fit_func19->GetParError(13));
       phi_2cbo_3->SetBinError(i,fit_func19->GetParError(14));

     
       n_3->SetBinContent(i,i+8);
       m=m+1;
 ...
 for(int i=1;i<=4;i++)
   ...
   foutput=new TFile("percalo_output_part3.root","new");
