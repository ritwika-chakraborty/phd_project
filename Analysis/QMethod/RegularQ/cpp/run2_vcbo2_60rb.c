...
fit_func->SetParameters(162652000000, 51641.3, 0.232192, 0, 2.16403, 0.00423897, 208305, 0.00292551, -1.4564);
   ...
   //, 1000000, 10000, 0.01, 0);
     ...
     //########## My VBO #########     
         ...
         fit_func->SetParameter(18, -1.2);
     fit_func->SetParameter(19,26431);
     fit_func->SetParameter(20,0.8);
     fit_func->SetParameter(21, 0.0);
     
   
     fit_func->SetParameter(14, 0.83862);
       fit_func->SetParameter(15, 17761.6);
     // fit_func->SetParameter(15, 67018.6);
     fit_func->SetParameter(16,0.191891);
     fit_func->SetParameter(17, 0);
  
     // fit_func->FixParameter(20, 0.800144);
     //  fit_func->FixParameter(19, 17328.5);
