...
char root_file_name[128] = "run3a_NE.root";

char muonloss_rootfile[128]="reconWmuonloss3a_mod.root";
//char muonloss_rootfile[128]="reconEmuonloss3a_mod.root";
...
TH1F *hlm, h0;
//TH1D *hlm, h0;
TCanvas *c1,*c2, *c3, *c4, *c5, *c6, *c7, *c8, *c9, *c10,*c11, *c12, *c13, *cfit, *cauto;
...
void run3btom_regular_q_fit()
 ...
 TDirectoryFile *dir[25];
    ...
    //  _file[0]->GetObject("lambda3A",hlm);
 ...
 fit_func->SetParNames("N_0", "Tau", "A", "Blind R", "Phi");
  ...
  c2->cd(3);
   ...
   hm->Draw();     
      ...
      fit_func9->SetParameter(5,0.0015);
  ...
  c12->cd(3);
   ...
   hm33->Draw();
      ...
      fit_func35->SetParameter(33,0.0016);
      fit_func35->SetParameter(34,24400);
