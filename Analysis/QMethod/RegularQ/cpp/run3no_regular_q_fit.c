...
char root_file_name[128] = "run3b_NE.root";

//char muonloss_rootfile[128]="reconWmuonloss3b_mod.root";
char muonloss_rootfile[128]="reconEmuonloss3b_mod.root";
...
void run3no_regular_q_fit()
 ...
 TDirectoryFile *dir[25];
  ...
  //_file[0]->GetObject("lambda3B",hlm);
