...
void run3a_nbinshift_syst()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   cout<<h_sum->GetBinWidth(1)<<" "<<h_sum->GetNbinsX()<<" "<<h_sum->GetBinLowEdge(1)<<" "<<(h_sum->GetBinLowEdge(h_sum->GetNbinsX())+h_sum->GetBinWidth(1))<<" "<<endl;
	...
	nbinshift=nbinshift+1;
       ...
       fit_func23->FixParameter(4, 230599);
       fit_func23->FixParameter(5, 0.0023296);
       ...
       fit_func23->FixParameter(12, 85337);
       fit_func23->FixParameter(13, 0.0138916);
       fit_func23->SetParameter(14, 0.273);
       fit_func23->SetParameter(15, -0.001);
       fit_func23->FixParameter(16, 15470);
       fit_func23->FixParameter(17, 0.0140996);
       ...
       /*  if(fit_func23->GetParError(1)<0.5)
	 {
       ...
       */
       ...
       h_res[i]= new TH1D("3a residual histogram ", "h_res", hr[i]->GetNbinsX(), hr[i]->GetBinLowEdge(1), (hr[i]->GetBinLowEdge(hr[i]->GetNbinsX())+hr[i]->GetBinWidth(1)));
  ...
  c2 = new TCanvas("c2","3a per calo residuals");
  c2->Divide(10,5);
  c3 = new TCanvas("c3","3a per calo fft");
  c3->Divide(10,5);
 ...
 for(int i=1;i<=50;i++)
   {
    ...
    c1=new TCanvas("c1","3a Ratio blind R vs caloriemeter #");
    gr1=new TGraphErrors(m,n,dblindR,0,0);
    gr1->SetTitle("3a dR vs 15 time decimation bin-shift");
    ...
    c4=new TCanvas("c4","3a nominal fit parameters vs caloriemeter #");
    c4->Divide(1,3);
    c4->cd(1);
    gr2=new TGraphErrors(m,n,A,0,dA);
    gr2->SetTitle("3a Asymmetry vs 15 time decimation bin-shift");
    ...
    gr3->SetTitle("3a Blind R vs 15 time decimation bin-shift");
    ...
    gr4->SetTitle("3a phase vs 15 time decimation bin-shift");
    ...
    gr5->SetTitle("3a A_cbo vs 15 time decimation bin-shift");
    ...
    gr6->SetTitle("3a omega_cbo vs 15 time decimation bin-shift");
    ...
    gr7->SetTitle("3a Tau_cbo vs 15 time decimation bin-shift");
    ...
    gr8->SetTitle("3a phase_cbo vs 15 time decimation bin-shift");
    ...
    c5=new TCanvas("c5","3a cbo fit parameters vs caloriemeter #");
    c5->Divide(2,2);
    c5->cd(1);
    gr5->Draw();
    c5->cd(2);
    ...
    c6=new TCanvas("c6","3a vw fit parameters vs caloriemeter #");
    c6->Divide(2,2);
    c6->cd(1);
    gr9=new TGraphErrors(m,n,A_vw,0,dA_vw);
    gr9->SetTitle("3a A_vw vs 15 time decimation bin-shift");
    ...
    gr10->SetTitle("3a omega_vw vs 15 time decimation bin-shift");
    ...
    gr11->SetTitle("3a Tau_vw vs 15 time decimation bin-shift");
    ...
    gr12->SetTitle("3a phase_vw vs 15 time decimation bin-shift");
