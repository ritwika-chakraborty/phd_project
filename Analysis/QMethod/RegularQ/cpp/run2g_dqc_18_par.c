...
//char root_file_name[128] = "run2g_corr.root";
...
void run2g_dqc_18_par()
 ...
 // h_sum->Rebin(8);
   ...
   h_sum->Rebin(8);
   // fit_func->SetParameters(1118530000/1.13, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);//multiplying by OOF
   fit_func->SetParameters(1970530000/0.955, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);//dividing by OOF 
   //, 0.002, 0.2);
