...
char root_file_name[128] = "run2d_thresh200_1800sr.root";
...
void run2_OOF_divided_fcl_18par()
 ...
 // h_sum->Rebin(8);
   ...
   h_sum->Rebin(8);
   fit_func->SetParameters(1400000000/1.13, 64439.4, 0.234041, 0, 2.22, 0.00261778, 208510, 0.00234020, 3.57360);
   //, 0.002, 0.2);
   //, 1000000, 10000, 0.01, 0);
     ...
     // fit_func->SetParameter(15, 193436);
      fit_func->SetParameter(15, 33436);
     ...
     //fit_func->FixParameter(13,0);
           ...
           h_sum->GetYaxis()->SetRangeUser(-100., 1500000000.);
