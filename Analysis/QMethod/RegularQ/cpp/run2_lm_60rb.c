...
void run2_lm_60rb()
 ...
 c2->cd(1);
  ...
  fit_func= new TF1("fprec", fprec,  100000,  350000, 14);
 ...
 // h_sum->Rebin(8);
   ...
   h_sum->Rebin(2);
   fit_func->SetParameters(161469000000, 51542.9, 0.23219, 0, 2.16411, 0.00426427, 206958, 0.00292548, -1);
   //, 0.002, 0.2);
   //, 1000000, 10000, 0.01, 0);
   
     fit_func->SetParameter(9,0.000711408);
     fit_func->SetParameter(10,0);
     fit_func->SetParameter(11, -0.000242035);
