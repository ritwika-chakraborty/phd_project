...
fit_func->SetParameters(170577000000, 51524.2, 0.234035, 0, 2.1616, 0.00431492, 201007, 0.00292548, -1.44150);

       fit_func->SetParameter(9, 0.000946335);
     fit_func->SetParameter(10, -7.33471);
     fit_func->SetParameter(11, 0.000272795);
   ...
   //, 1000000, 10000, 0.01, 0);
     ...
     fit_func->SetParameter(15, 15695.9);
