...
void chi2(Int_t &npar, Double_t *gin, Double_t &f, Double_t *par, Int_t inf)
{
 ...
 //  fit_func->SetParameters(1580000000/2.5, 51568, 0.2, 135.54, 3.14/2, 0.01, 128325, 0.0029, 3.14/2);
   fit_func->SetParameters(1580000000/3.4, 51568, 0.2, 135.54, 3.14/2, 0.01, 128325, 0.0029, 1.57, 0.0, 1.5);//calo 1
  ...
  //  h[1]->Rebin(4);
   ...
   c4->cd(1);
    ...
    hcomp->GetYaxis()->SetRangeUser(-100., 80000000.);
