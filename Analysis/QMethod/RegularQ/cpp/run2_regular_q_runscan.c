...
char root_file_name_1[128] = "run2C_thresh300_fbfDQC_wndw_8.root";
char root_file_name_2[128] = "run2D_thresh300_fbfDQC_wndw_8.root";
char root_file_name_3[128] = "run2E_thresh300_fbfDQC_wndw_8.root";
char root_file_name_4[128] = "run2F_thresh300_fbfDQC_wndw_8.root";
char root_file_name_5[128] = "run2G_thresh300_fbfDQC_wndw_8.root";
char root_file_name_6[128] = "run2H_thresh300_fbfDQC_wndw_8.root";
 ...
 c2->cd(1);
  ...
  c4->cd(3);
   ...
   hm13->Draw();     
      ...
      fit_func17->FixParameter(14,30229);
      fit_func17->FixParameter(15, 0.014033);
  ...
  c5->cd(3);
   ...
   hm17->Draw();     
      ...
      fit_func21->FixParameter(18,148809);
      fit_func21->FixParameter(19, 0.01393);
