...
void run2_nominal_ns()
 ...
 fit_func->SetNpx(1000000);
  ...
  gStyle->SetOptFit(1111);
   ...
   //  fit_func->SetParameters(23300000000/2.75, 51540*1.25, 0.2, 0.0, 3.14/2);

   fit_func->SetParameters((1.02020e+11)/1.23, 51540*1.25, 0.2, 0.0, 3.14/2);
