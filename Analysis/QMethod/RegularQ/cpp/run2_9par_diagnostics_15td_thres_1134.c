...
void run2_9par_diagnostics_15td_thres_1134()
 ...
 // {
     ...
     fit_func->SetParameters(1580000000/3.6, 51568, 0.2, 136, 3.14/2, 0.05, 158000, 0.0029, (3/4)*3.14);
			     //, 0, 0);
  ...
  c2->cd(3);
   ...
   hm->Draw();
     */
     	     cout<<"calo "<<2<<" "<<endl;
     h[m]->Rebin(8);
     fit_func->SetParameters(1580000000/3.8, 51568, 0.3, 135.54, 3.14/2, 0.05, 158325, 0.0029, 3.14/2);
     //, 0,0);
     /*  fit_func->SetParameter(11,0);
     fit_func->SetParameter(12,0);
     fit_func->SetParameter(13,0);
     ...
     */
     ...
     cout<<"calo "<<4<<" "<<endl;
     h[m]->Rebin(8);
     fit_func->SetParameters(1580000000/3.8, 51568, 0.2, 135.54, 3.14/2, 0.05, 158325, 0.0029, 3.14/2);
     //, 0,0);
     /* fit_func->SetParameter(11,0);
     fit_func->SetParameter(12,0);
     fit_func->SetParameter(13,0);
    ...
    */
     ...
     cout<<"calo "<<8<<" "<<endl;
     h[m]->Rebin(8);
     fit_func->SetParameters(1580000000/4.1, 51568, 0.2, 135.54, 3.14/2, 0.05, 148325, 0.0029, 3.14/2);
     //, 0,0);
     /* fit_func->SetParameter(11,0);
     fit_func->SetParameter(12,0);
     fit_func->SetParameter(13,0);
   ...
   */
     ...
     */
     ...
     cout<<"calo "<<22<<" "<<endl;
     h[m]->Rebin(8);
     fit_func->SetParameters(1580000000/3.2, 51568, 0.2, 135.54, 3.14/2, 0.05, 148000, 0.0029, (3*3.14)/4);
     //, 0,0);
     /*  fit_func->SetParameter(11,0);
     fit_func->SetParameter(12,0);
     fit_func->SetParameter(13,0);
