...
char rootfilename[128]="run2CDEFGH.root";
...
void run2_caloscan()
 ...
 {
   Double_t chi15[40], chi60[40], life[40],dlife[40],freq[40],dfreq[40],norm[40],dnorm[40],phi[40],dphi[40],blindR[40],dblindR[40];
   Double_t n[40];
   Int_t m=1;
   Double_t N;
 ...
 gStyle->SetOptFit(1111);
      ...
      cout<<"Calo "<<m<<endl;
   fit_func->SetParameters(3500000000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
  ...
  c2->cd(3);
   ...
   return;*/
    cout<<"Calo "<<m<<endl;
    fit_func->SetParameters(3530000000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 208510, 0.00234020, 3.57360);
     ...
     cout<<"Calo "<<m<<endl;
       fit_func->SetParameters(3530000000/1.15, 64439.4, 0.234041, 0, 2.22, 0.00261778, 208510, 0.00234020, 3.57360);
     ...
     cout<<"Calo "<<m<<endl;
          fit_func->SetParameters(3530000000/1.04, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     cout<<"calo "<<m<<endl;
       fit_func->SetParameters(3530000000/0.98, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     fit_func->SetParameter(14, 0.00638136);
     fit_func->SetParameter(15, 213436);
     ...
     cout<<"calo "<<m<<endl;
       fit_func->SetParameters(3530000000/1.21, 64439.4, 0.234041, 0, 2.22, 0.00261778, 208510, 0.00234020, 3.57360);
     ...
     cout<<"calo "<<m<<endl;
       fit_func->SetParameters(3530000000/1.2, 64439.4, 0.234041, 0, 2.22, 0.00261778, 228510, 0.00234020, 3.57360);
     ...
     cout<<"calo "<<m<<endl;
       fit_func->SetParameters(3530000000/1.2, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     cout<<"calo "<<m<<endl;
       fit_func->SetParameters(3530000000/1.32, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     //  return;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(3530000000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     // return;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(3530000000/1.15, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     // return;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(3530000000/0.99, 64439.4, 0.234041, 0, 2.22, 0.00261778, 228510, 0.00234020, 3.57360);
     ...
     //   return;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(3530000000/1.1, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
    ...
    n[m]=m;
     ...
     //  return;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(3530000000/1.1, 64439.4, 0.234041, 0, 2.22, 0.00261778, 218510, 0.00234020, 3.57360);
     ...
     gr1->Draw();
       ...
       gr2=new TGraphErrors(m,n,blindR ,0,dblindR);
     gr2->SetTitle("Blind R vs calo#");
     gr2->GetXaxis()->SetTitle("calo #");
     gr2->GetYaxis()->SetTitle("Blind R");
