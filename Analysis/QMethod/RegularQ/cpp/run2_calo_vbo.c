...
void run2_calo_vbo()
 ...
 //gStyle->SetOptFit(1111);
  ...
  h_sum= new TH1D("calo histogram", "calo 1", h[1]->GetNbinsX(), 100001, 352001);
  h_sum->Sumw2(kTRUE);
 ...
 // h_sum->Rebin(8);
   ...
   fit_func->SetParameters(932200000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
   //, 0.002, 0.2);
   //, 1000000, 10000, 0.01, 0);
     ...
     fit_func->SetParameter(15, 19343.6);
     ...
     //fit_func->FixParameter(13,0);
           ...
           h_sum->GetYaxis()->SetRangeUser(-100., 30000000000./24);
