...
fit_func->SetParameters(7192270000, 51004.6, 0.207044, 0, 2.3174, -0.0114425, 141840, 0.00292833, 1.52848);
   ...
   //, 1000000, 10000, 0.01, 0);
     ...
     fit_func->SetParameter(19, 15551.6); //Tau2_vbo
