...
char muonloss_rootfile[128]="reconWmuonloss2_mod.root";
//char muonloss_rootfile[128]="reconEmuonloss2_mod.root";
//char muonloss_rootfile[128]="LostMuonsSpectra.root";
//char muonloss_rootfile[128]="reconEmuonloss.root";
...
//TH1 *hm;
TH1F *hlm, h0;
TCanvas *c1,*c2, *c3, *c4, *c5, *c6, *c7, *c8, *c9, *c10,*c11, *c12, *c13, *c14, *cfit, *cauto;
TF1 *fit_func, *fit_func9, *fit_func13, *fit_func17, *fit_func21, *fit_func25, *fit_func26, *fit_func29 ,*fit_func30, *fit_func31,*fit_func32,*fit_func33, *fit_func35;
TH1D *h_res, *h_res9, *h_res13, *h_res17, *h_res21, *h_res25, *h_res26, *h_res29,*h_res30, *h_res31, *h_res32, *h_res33, *h_res35,  *h_res_final;
TH1 *hm, *hm9, *hm13, *hm17, *hm21, *hm25, *hm26,  *hm29, *hm30, *hm31, *hm32, *hm33, *hm35, *hFFTsq, *hfft_final, *hAuto;
...
Double_t fprec33(Double_t *x, Double_t *par)
{
    double norm = par[0];
...
Double_t fprec35(Double_t *x, Double_t *par)
{
    double norm = par[0];
    ...
    double A_cbo_t = par[33];

    double tau_cbo_t = par[34];

    double time = x[0];
    
    double omega_a = 1.e-3 * getBlinded.paramToFreq(R);

    double omega_cbo_t = omega_cbo*(1 + A_cbo_t * exp (-time/tau_cbo_t));

    //double omega_2cbo_t = omega_2cbo*(1 + A_cbo_t * exp (-time/tau_cbo_t));

    double Acbox =  (1 + A2_cbo * exp(-time/Tau_cbo) * (cos(omega_cbo_t*time - phi2_cbo)));

    double phicbox = A3_cbo * exp(-time/Tau_cbo) * (cos(omega_cbo_t*time - phi3_cbo));

    double Ncbox = (1 + A_cbo * exp(-time/Tau_cbo) * (cos(omega_cbo_t*time - phi_cbo)));
 ...
 fit_func->SetParNames("N_0", "Tau", "A", "Blind R", "Phi");
  ...
  c2->cd(3);
   ...
   hm->Draw();     
      ...
      fit_func9->SetParameter(6,237260);
      fit_func9->SetParameter(7,0.0023403);
  ...
  c4->cd(3);
   ...
   hm13->Draw();     
      ...
      fit_func17->SetParameter(14,17967);
  ...
  c5->cd(3);
   ...
   hm17->Draw();     
      ...
      fit_func21->SetParameter(18,374395);
      fit_func21->SetParameter(19, 0.01392);
  ...
  c6->cd(3);
   ...
   //  return;
      ...
      fit_func25->SetParameter(22,fit_func21->GetParameter(6)/2);
      fit_func25->SetParameter(23,2*fit_func21->GetParameter(7));
  ...
  c11->cd(3);
   ...
   return;
      ...
      fit_func33= new TF1("fprec33", fprec33,  30000,  309000, 33);
      fit_func33->SetParNames("N_0", "Tau", "A", "Blind R", "Phi", "A_cbo", "Tau_cbo", "omega_cbo", "phi_cbo");
      fit_func33->SetParName(9, "A2_cbo");
      fit_func33->SetParName(10, "phi2_cbo");
      fit_func33->SetParName(11, "A3_cbo");
      fit_func33->SetParName(12, "phi3_cbo");
      fit_func33->SetParName(13, "A_vw");
      fit_func33->SetParName(14, "Tau_vw");
      fit_func33->SetParName(15, "omega_vw");
      fit_func33->SetParName(16, "phi_vw");
      fit_func33->SetParName(17, "A_vbo");
      fit_func33->SetParName(18, "Tau_vbo");
      fit_func33->SetParName(19, "omega_vbo");
      fit_func33->SetParName(20, "phi_vbo");
      fit_func33->SetParName(21, "A_2cbo");
      fit_func33->SetParName(22, "Tau_2cbo");
      fit_func33->SetParName(23, "omega_2cbo");
      fit_func33->SetParName(24, "phi_2cbo");
      fit_func33->SetParName(25, "A_new");
      fit_func33->SetParName(26, "Tau_new");
      fit_func33->SetParName(27, "omega_new");
      fit_func33->SetParName(28, "phi_new");
      fit_func33->SetParName(29, "A_VD");
      fit_func33->SetParName(30, "Tau_VD");
      fit_func33->SetParName(31, "lm_amp");
      fit_func33->SetParName(32, "tau_rlx");



      fit_func33->SetNpx(10000000);
      fit_func33->SetParameter(0,fit_func32->GetParameter(0));
      fit_func33->SetParameter(1,fit_func32->GetParameter(1));
      fit_func33->SetParameter(2,fit_func32->GetParameter(2));
      fit_func33->SetParameter(3,fit_func32->GetParameter(3));
      fit_func33->SetParameter(4,fit_func32->GetParameter(4));
      fit_func33->SetParameter(5,fit_func32->GetParameter(5));
      fit_func33->SetParameter(6,fit_func32->GetParameter(6));
      fit_func33->SetParameter(7,fit_func32->GetParameter(7));
      fit_func33->SetParameter(8,fit_func32->GetParameter(8));
      fit_func33->SetParameter(9,fit_func32->GetParameter(9));
      fit_func33->SetParameter(10,fit_func32->GetParameter(10));
      fit_func33->SetParameter(11,fit_func32->GetParameter(11));
      fit_func33->SetParameter(12,fit_func32->GetParameter(12));
      fit_func33->SetParameter(13,fit_func32->GetParameter(13));
      fit_func33->SetParameter(14,fit_func32->GetParameter(14));
      fit_func33->SetParameter(15,fit_func32->GetParameter(15));
      fit_func33->SetParameter(16,fit_func32->GetParameter(16));
      fit_func33->SetParameter(17,fit_func32->GetParameter(17));
      fit_func33->SetParameter(18,fit_func32->GetParameter(18));
      fit_func33->SetParameter(19,fit_func32->GetParameter(19));
      fit_func33->SetParameter(20,fit_func32->GetParameter(20));
      fit_func33->SetParameter(21,fit_func32->GetParameter(21));
      fit_func33->FixParameter(22,fit_func32->GetParameter(22));
      fit_func33->FixParameter(23,fit_func32->GetParameter(23));
      fit_func33->SetParameter(24,fit_func32->GetParameter(24));
      fit_func33->SetParameter(25,fit_func32->GetParameter(25));
      fit_func33->SetParameter(26,fit_func32->GetParameter(26));
      fit_func33->SetParameter(27,fit_func32->GetParameter(27));
      fit_func33->SetParameter(28,fit_func32->GetParameter(28));
      fit_func33->SetParameter(29,fit_func32->GetParameter(29));
      fit_func33->SetParameter(30,fit_func32->GetParameter(30));
      fit_func33->SetParameter(31,0.0);
      fit_func33->SetParameter(32, 290000000);
      ...
      c12 = new TCanvas("c12","33 parameter fit");
      c12->Divide(1,3);
      c12->cd(1);
      
      		h_sum->Fit(fit_func33,"R","",fit_start,fit_stop);

                freq[9]=fit_func33->GetParameter(3);
			dfreq[9]=fit_func33->GetParError(3);
		
                h_sum->Draw();
		h_res33= new TH1D("residual histogram 33", "h_res 33", h_sum->GetNbinsX(), h_sum->GetBinLowEdge(1), (h_sum->GetBinLowEdge(h_sum->GetNbinsX())+h_sum->GetBinWidth(1)));
	...
	for (int ibin = ((fit_start + 1- h_sum->GetBinLowEdge(1))/h_sum->GetBinWidth(1))+1; ibin <= ((fit_stop + 1 - h_sum->GetBinLowEdge(1))/h_sum->GetBinWidth(1))+1; ++ibin)
     {
      ...
      double res =  (h_sum->GetBinContent(ibin)- fit_func33->Eval( h_sum->GetBinCenter(ibin) ) );
      if(h_sum->GetBinError(ibin)!=0){res=(res/h_sum->GetBinError(ibin));}
      h_res33->SetBinContent(ibin, (res)  );
     
      }

	h_res33->GetYaxis()->SetTitle("ADC counts");
	h_res33->GetXaxis()->SetTitle("time [ns]");
	h_res33->GetXaxis()->SetRangeUser(fit_start,fit_stop);
	h_res33->GetXaxis()->SetLabelSize(0.04);
	h_res33->GetYaxis()->SetLabelSize(0.04);
        h_res33->Draw();

  c12->cd(3);
     hm33 = h_res33->FFT(hm33, "MAG");
   hm33->SetLineColor(kBlack);
   //  hm->SetBins(h_res->GetNbinsX(),0,h_res->GetNbinsX()/((h_res->GetBinLowEdge(h_res->GetNbinsX())+h_res->GetBinWidth(1))));
   hm33->SetBins(h_res33->GetNbinsX(), 0, 1/h_res33->GetBinWidth(1));
   //hm->GetXaxis()->SetRangeUser(0,h_res->GetNbinsX()/((h_res->GetBinLowEdge(h_res->GetNbinsX())+h_res->GetBinWidth(1)))/2);
   hm33->GetXaxis()->SetRangeUser(0,1/(2*h_res33->GetBinWidth(1)));
   hm33->GetXaxis()->SetTitle("Freq [GHz]");
   hm33->GetYaxis()->SetTitle("FFT Mag [arb. units]");
   hm33->Draw();

      fit_func35= new TF1("fprec35", fprec35,  30000,  309000, 35);
      fit_func35->SetParNames("N_0", "Tau", "A", "Blind R", "Phi", "A_cbo", "Tau_cbo", "omega_cbo", "phi_cbo");
      fit_func35->SetParName(9, "A2_cbo");
      fit_func35->SetParName(10, "phi2_cbo");
      fit_func35->SetParName(11, "A3_cbo");
      fit_func35->SetParName(12, "phi3_cbo");
      fit_func35->SetParName(13, "A_vw");
      fit_func35->SetParName(14, "Tau_vw");
      fit_func35->SetParName(15, "omega_vw");
      fit_func35->SetParName(16, "phi_vw");
      fit_func35->SetParName(17, "A_vbo");
      fit_func35->SetParName(18, "Tau_vbo");
      fit_func35->SetParName(19, "omega_vbo");
      fit_func35->SetParName(20, "phi_vbo");
      fit_func35->SetParName(21, "A_2cbo");
      fit_func35->SetParName(22, "Tau_2cbo");
      fit_func35->SetParName(23, "omega_2cbo");
      fit_func35->SetParName(24, "phi_2cbo");
      fit_func35->SetParName(25, "A_new");
      fit_func35->SetParName(26, "Tau_new");
      fit_func35->SetParName(27, "omega_new");
      fit_func35->SetParName(28, "phi_new");
      fit_func35->SetParName(29, "A_VD");
      fit_func35->SetParName(30, "Tau_VD");
      fit_func35->SetParName(31, "lm_amp");
      fit_func35->SetParName(32, "tau_rlx");
      fit_func35->SetParName(33, "A_cbo_t");
      fit_func35->SetParName(34, "tau_cbo_t");




      fit_func35->SetNpx(10000000);
      fit_func35->SetParameter(0,fit_func33->GetParameter(0));
      fit_func35->SetParameter(1,fit_func33->GetParameter(1));
      fit_func35->SetParameter(2,fit_func33->GetParameter(2));
      fit_func35->SetParameter(3,fit_func33->GetParameter(3));
      fit_func35->SetParameter(4,fit_func33->GetParameter(4));
      fit_func35->SetParameter(5,fit_func33->GetParameter(5));
      fit_func35->SetParameter(6,fit_func33->GetParameter(6));
      fit_func35->SetParameter(7,fit_func33->GetParameter(7));
      fit_func35->SetParameter(8,fit_func33->GetParameter(8));
      fit_func35->SetParameter(9,fit_func33->GetParameter(9));
      fit_func35->SetParameter(10,fit_func33->GetParameter(10));
      fit_func35->SetParameter(11,fit_func33->GetParameter(11));
      fit_func35->SetParameter(12,fit_func33->GetParameter(12));
      fit_func35->SetParameter(13,fit_func33->GetParameter(13));
      fit_func35->SetParameter(14,fit_func33->GetParameter(14));
      fit_func35->SetParameter(15,fit_func33->GetParameter(15));
      fit_func35->SetParameter(16,fit_func33->GetParameter(16));
      fit_func35->SetParameter(17,fit_func33->GetParameter(17));
      fit_func35->SetParameter(18,fit_func33->GetParameter(18));
      fit_func35->SetParameter(19,fit_func33->GetParameter(19));
      fit_func35->SetParameter(20,fit_func33->GetParameter(20));
      fit_func35->SetParameter(21,fit_func33->GetParameter(21));
      fit_func35->FixParameter(22,fit_func33->GetParameter(22));
      fit_func35->FixParameter(23,fit_func33->GetParameter(23));
      fit_func35->SetParameter(24,fit_func33->GetParameter(24));
      fit_func35->SetParameter(25,fit_func33->GetParameter(25));
      fit_func35->SetParameter(26,fit_func33->GetParameter(26));
      fit_func35->SetParameter(27,fit_func33->GetParameter(27));
      fit_func35->SetParameter(28,fit_func33->GetParameter(28));
      fit_func35->SetParameter(29,fit_func33->GetParameter(29));
      fit_func35->SetParameter(30,fit_func33->GetParameter(30));
      fit_func35->SetParameter(31,0.0);
      fit_func35->SetParameter(32,fit_func33->GetParameter(32));
      fit_func35->SetParameter(33,0.007);
      fit_func35->FixParameter(34,19400);


      c13 = new TCanvas("c13","35 parameter fit");
      c13->Divide(1,3);
      c13->cd(1);
      
      		h_sum->Fit(fit_func35,"R","",fit_start,fit_stop);

                freq[10]=fit_func35->GetParameter(3);
			dfreq[10]=fit_func35->GetParError(3);
		
                h_sum->Draw();
		h_res35= new TH1D("residual histogram 35", "h_res 35", h_sum->GetNbinsX(), h_sum->GetBinLowEdge(1), (h_sum->GetBinLowEdge(h_sum->GetNbinsX())+h_sum->GetBinWidth(1)));
	...
	for (int ibin = ((fit_start + 1- h_sum->GetBinLowEdge(1))/h_sum->GetBinWidth(1))+1; ibin <= ((fit_stop + 1 - h_sum->GetBinLowEdge(1))/h_sum->GetBinWidth(1))+1; ++ibin)
     {
      ...
      double res =  (h_sum->GetBinContent(ibin)- fit_func35->Eval( h_sum->GetBinCenter(ibin) ) );
      if(h_sum->GetBinError(ibin)!=0){res=(res/h_sum->GetBinError(ibin));}
      h_res35->SetBinContent(ibin, (res)  );
     
      }

	h_res35->GetYaxis()->SetTitle("ADC counts");
	h_res35->GetXaxis()->SetTitle("time [ns]");
	h_res35->GetXaxis()->SetRangeUser(fit_start,fit_stop);
	h_res35->GetXaxis()->SetLabelSize(0.04);
	h_res35->GetYaxis()->SetLabelSize(0.04);
        h_res35->Draw();

  c13->cd(3);
   hm35 = h_res35->FFT(hm35, "MAG");
   hm35->SetLineColor(kBlack);
   //  hm->SetBins(h_res->GetNbinsX(),0,h_res->GetNbinsX()/((h_res->GetBinLowEdge(h_res->GetNbinsX())+h_res->GetBinWidth(1))));
   hm35->SetBins(h_res35->GetNbinsX(), 0, 1/h_res35->GetBinWidth(1));
   //hm->GetXaxis()->SetRangeUser(0,h_res->GetNbinsX()/((h_res->GetBinLowEdge(h_res->GetNbinsX())+h_res->GetBinWidth(1)))/2);
   hm35->GetXaxis()->SetRangeUser(0,1/(2*h_res35->GetBinWidth(1)));
   hm35->GetXaxis()->SetTitle("Freq [GHz]");
   hm35->GetYaxis()->SetTitle("FFT Mag [arb. units]");
   hm35->Draw();     
...
;
       for(int ix=h_sum->FindBin(fit_start);ix<=cov.GetRowUpb();ix++)
	 {
       ...
       fit_func25->SetParameter(22, fit_func25->GetParameter(22));
       fit_func25->SetParameter(23, fit_func25->GetParameter(23));
