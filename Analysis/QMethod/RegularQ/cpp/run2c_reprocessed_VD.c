...
void run2c_reprocessed_VD()
 ...
 c2->cd(1);
  ...
  fit_func= new TF1("fprec", fprec,  30000,  309000, 29);
 ...
 // h_sum->Rebin(8);
   ...
   h_sum->Rebin(8);
    fit_func->SetParameters(11593900000, 64439.1, 0.2337, 0, 2.22, 0.002533, 238522, 0.0023405, 3.323);
   ...
   //, 1000000, 10000, 0.01, 0);
     ...
     fit_func->SetParameter(11, -0.0000632);
     fit_func->SetParameter(12,-8.6);
     ...
     //  fit_func->FixParameter(16,0.1535);
           ...
           h_sum->GetYaxis()->SetRangeUser(-100., 12500000000.);
