...
void run2_9par_diagnostics_60td()
 ...
 cout<<sum<<" "<<endl;
  ...
  h_sum= new TH1D("calo histogram sum", "h_sum", h[1]->GetNbinsX(), 100001, 292481);
  h_sum->Sumw2(kTRUE);
 ...
 fit_func= new TF1("fprec", fprec,  114000,  290000, 9);
 ...
 Double_t fit_start=135000;
 Double_t fit_stop=290000;
 // for(Int_t i=1; i<=24; i++)
 // {
     cout<<"calo "<<1<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(15800000, 51568, 0.2, 136, 3.14/2, 0.06, 148325, 0.0029, 3.14/2);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
     h[m]->GetYaxis()->SetRangeUser(-100., 3000000.);
     // h[m]->Draw();
     // fit_func->Draw("same");
     ...
     cout<<"reduced chi "<<chi[m]<<" "<<endl;
        m=m+1;
	/*  h_res= new TH1D("residual histogram", "h_res", h[m]->GetNbinsX(), 100001, 292481);
     c2->cd(2);
  ...
  c2->cd(3);
   ...
   hm->Draw();
     ...
     */
     ...
     cout<<"calo "<<2<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.5, 51568, 0.2, 135.54, 3.14/2, 0.05, 158325, 0.0029, 3.14/2);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
     ...
     m=m+1;
      ...
      cout<<"calo "<<5<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.6, 51568, 0.2, 135.54, 3.14/2, 0.05, 158325, 0.0029, 3.14/2);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
     h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
     // h[m]->Draw();
     ...
     cout<<"calo "<<6<<" "<<endl;
    h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.85, 51568, 0.2, 135.54, 3.14/2, 0.05, 158325, 0.0029, 3.14);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
     h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
     // h[m]->Draw();
     ...
     cout<<"calo "<<7<<" "<<endl;
    h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.65, 51568, 0.2, 135.54, 3.14/2, 0.05, 158325, 0.0029, 3.14/2);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      // h[m]->Draw();
     ...
     cout<<"calo "<<8<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/3.1, 51568, 0.2, 135.54, 3.14/2, 0.05, 158325, 0.0029, 3.14/2);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
     h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
     // h[m]->Draw();
     ...
     cout<<"calo "<<9<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.8, 51568, 0.2, 135.54, 3.14/2, 0.05, 148000, 0.0029, (3*3.14)/4);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      //  h[m]->Draw();
     ...
     n[m]=m;
       m=m+1;
          ...
          cout<<"calo "<<10<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/3, 51568, 0.2, 135.54, 3.14/2, 0.01, 148000, 0.0029, (3*3.14)/4);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      //  h[m]->Draw();
     ...
     n[m]=m;
       m=m+1;
        ...
        cout<<"calo "<<12<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(15800000, 51568, 0.2, 135.54, 3.14/2, 0.05, 140000, 0.0029, (3*3.14)/4);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      // h[m]->Draw();
     ...
     n[m]=m;
       ...
       cout<<"calo "<<13<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.7, 51568, 0.2, 135.54, 3.14/2, 0.05, 140000, 0.0029, (3*3.14)/4);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      // h[m]->Draw();
     ...
     n[m]=m;
       m=m+1;
        ...
        cout<<"calo "<<14<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.5, 51568, 0.2, 135.54, 3.14/2, 0.05, 140000, 0.0029, (3*3.14)/4);
     // c2->cd(i);
     //  fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      // h[m]->Draw();
     ...
     n[m]=m;
       m=m+1;
            ...
            cout<<"calo "<<19<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.4, 51568, 0.2, 135.54, 3.14/2, 0.05, 140000, 0.0029, (3*3.14)/4);
     // c2->cd(i);
     //  fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      //  h[m]->Draw();
     ...
     n[m]=m;
      ...
      cout<<"calo "<<20<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.2, 51568, 0.2, 135.54, 3.14/2, 0.05, 140000, 0.0029, (3*3.14)/4);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      // h[m]->Draw();
     ...
     n[m]=m;
       m=m+1;
        ...
        cout<<"calo "<<21<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.8, 51568, 0.2, 135.54, 3.14/2, 0.05, 140000, 0.0029, (3*3.14)/4);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      //  h[m]->Draw();
     ...
     cout<<"calo "<<22<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.3, 51568, 0.2, 135.54, 3.14/2, 0.05, 140000, 0.0029, (3*3.14)/4);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      // h[m]->Draw();
     ...
     n[m]=m;
       m=m+1;
             ...
             cout<<"calo "<<23<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.4, 51568, 0.2, 135.54, 3.14/2, 0.05, 150000, 0.0029, 0);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      // h[m]->Draw();
     ...
     n[m]=m;
       m=m+1;
             ...
             cout<<"calo "<<24<<" "<<endl;
     h[m]->Rebin(2);
     fit_func->SetParameters(1580000000/2.6, 51568, 0.2, 135.54, 3.14/2, 0.05, 150000, 0.0029, 0);
     // c2->cd(i);
     // fit_func->SetParLimits(8, -6.28, 6.28);
      h[m]->GetYaxis()->SetRangeUser(-100., 120000000.);
      //  h[m]->Draw();
