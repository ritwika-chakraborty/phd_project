...
char rootfilename[128]="run2c350MeV.root";
...
Double_t fprec(Double_t *x, Double_t *par)
{
    ...
    return norm * exp(-time/life) * (1 + asym * (1-A2_cbo * exp(-time/Tau_cbo) * (cos(omega_cbo*time+phi2_cbo))) * cos(omega_a*time + (phi + A3_cbo * exp(-time/Tau_cbo) * (cos(omega_cbo*time+phi3_cbo))))) * (1-A_cbo * exp(-time/Tau_cbo) * (cos(omega_cbo*time+phi_cbo))) * ( 1- lost_muon_amp * hlm->GetBinContent(hlm->GetXaxis()->FindBin( time * 1.0e-3)))  * (1-A_vbo * exp(-time/Tau_vbo) * (cos(omega_vbo*time+phi_vbo))) * (1-A_vbo2 * exp(-time/Tau_vbo2) * (cos(omega_vbo2*time+phi_vbo2)));
...
void run2c_reprocessed_caloscan()

 {
   Double_t chi15[40], chi60[40], life[40],dlife[40],freq[40],dfreq[40],norm[40],dnorm[40],phi[40],dphi[40],blindR[40],dblindR[40], asym[40], dasym[40], hcboN[40],dhcboN[40],hcbolife[40],dhcbolife[40],hcbofreq[40],dhcbofreq[40],hcbophi[40],dhcbophi[40],mloss[40],dmloss[40];
   Double_t n[40];
   Int_t m=1;
   Double_t N;
 ...
 TDirectoryFile *dir[25];
  ...
  _file[1]=TFile::Open(rootfilename);
  ...
  _file[2]=TFile::Open(rootfilename);
  ...
  hg[2]=(TH1D*)qHist_2[2]->Clone();
   ...
   _file[3]=TFile::Open(rootfilename);
  ...
  hg[3]=(TH1D*)qHist_2[3]->Clone();
   ...
   _file[4]=TFile::Open(rootfilename);
 ...
 dir[4]->GetObject("qHist1D_sig_4_2",qHist_2[4]);
  hg[4]=(TH1D*)qHist_2[4]->Clone();
   ...
   _file[5]=TFile::Open(rootfilename);
 ...
 dir[5]->GetObject("qHist1D_sig_5_2",qHist_2[5]);
  hg[5]=(TH1D*)qHist_2[5]->Clone();
   ...
   _file[6]=TFile::Open(rootfilename);
 ...
 dir[6]->GetObject("qHist1D_sig_6_2",qHist_2[6]);
  hg[6]=(TH1D*)qHist_2[6]->Clone();
   ...
   _file[7]=TFile::Open(rootfilename);
 ...
 dir[7]->GetObject("qHist1D_sig_7_2",qHist_2[7]);
  hg[7]=(TH1D*)qHist_2[7]->Clone();
   ...
   _file[8]=TFile::Open(rootfilename);
 ...
 dir[8]->GetObject("qHist1D_sig_8_2",qHist_2[8]);
  hg[8]=(TH1D*)qHist_2[8]->Clone();
   ...
   _file[9]=TFile::Open(rootfilename);
 ...
 dir[9]->GetObject("qHist1D_sig_9_2",qHist_2[9]);
  hg[9]=(TH1D*)qHist_2[9]->Clone();
   ...
   _file[10]=TFile::Open(rootfilename);
 ...
 dir[10]->GetObject("qHist1D_sig_10_2",qHist_2[10]);
  hg[10]=(TH1D*)qHist_2[10]->Clone();
   ...
   _file[11]=TFile::Open(rootfilename);
 ...
 dir[11]->GetObject("qHist1D_sig_11_2",qHist_2[11]);
  hg[11]=(TH1D*)qHist_2[11]->Clone();
   ...
   _file[12]=TFile::Open(rootfilename);
 ...
 dir[12]->GetObject("qHist1D_sig_12_2",qHist_2[12]);
  hg[12]=(TH1D*)qHist_2[12]->Clone();
   ...
   _file[13]=TFile::Open(rootfilename);
 ...
 dir[13]->GetObject("qHist1D_sig_13_2",qHist_2[13]);
  hg[13]=(TH1D*)qHist_2[13]->Clone();
   ...
   _file[14]=TFile::Open(rootfilename);
 ...
 dir[14]->GetObject("qHist1D_sig_14_2",qHist_2[14]);
  hg[14]=(TH1D*)qHist_2[14]->Clone();
   ...
   _file[15]=TFile::Open(rootfilename);
 ...
 dir[15]->GetObject("qHist1D_sig_15_2",qHist_2[15]);
  hg[15]=(TH1D*)qHist_2[15]->Clone();
   ...
   _file[16]=TFile::Open(rootfilename);
 ...
 dir[16]->GetObject("qHist1D_sig_16_2",qHist_2[16]);
  hg[16]=(TH1D*)qHist_2[16]->Clone();
   ...
   _file[17]=TFile::Open(rootfilename);
 ...
 dir[17]->GetObject("qHist1D_sig_17_2",qHist_2[17]);
  hg[17]=(TH1D*)qHist_2[17]->Clone();
   ...
   _file[18]=TFile::Open(rootfilename);
 ...
 dir[18]->GetObject("qHist1D_sig_18_2",qHist_2[18]);
  hg[18]=(TH1D*)qHist_2[18]->Clone();
   ...
   _file[19]=TFile::Open(rootfilename);
 ...
 dir[19]->GetObject("qHist1D_sig_19_2",qHist_2[19]);
  hg[19]=(TH1D*)qHist_2[19]->Clone();
   ...
   _file[20]=TFile::Open(rootfilename);
 ...
 dir[20]->GetObject("qHist1D_sig_20_2",qHist_2[20]);
  hg[20]=(TH1D*)qHist_2[20]->Clone();
   ...
   _file[21]=TFile::Open(rootfilename);
 ...
 dir[21]->GetObject("qHist1D_sig_21_2",qHist_2[21]);
  hg[21]=(TH1D*)qHist_2[21]->Clone();
   ...
   _file[22]=TFile::Open(rootfilename);
 ...
 dir[22]->GetObject("qHist1D_sig_22_2",qHist_2[22]);
  hg[22]=(TH1D*)qHist_2[22]->Clone();
   ...
   _file[23]=TFile::Open(rootfilename);
 ...
 dir[23]->GetObject("qHist1D_sig_23_2",qHist_2[23]);
  hg[23]=(TH1D*)qHist_2[23]->Clone();
   ...
   _file[24]=TFile::Open(rootfilename);
   ...
   for(Int_t i=1; i<=24; i++)
     {
       ...
       h[i]->Rebin(8);
       h[i]->GetYaxis()->SetRangeUser(-100., 4000000000.);
       ...
       hg[i]->Rebin(2);
       hg[i]->GetYaxis()->SetRangeUser(-100., 4000000000.);
 ...
 gStyle->SetOptFit(1111);
      ...
      cout<<"Calo "<<m<<endl;
         fit_func->SetParameters(1904890000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     fit_func->SetParameter(14, -0.00138);
     fit_func->SetParameter(15, 25343);
     fit_func->SetParameter(16, 0.1535);
     fit_func->SetParameter(17, 4.2);

     fit_func->SetParameter(18, 0.000235);
     fit_func->SetParameter(19,242466);
     fit_func->SetParameter(20, 0.13959);
     fit_func->SetParameter(21, -0.149);

     fit_func->FixParameter(15,25590);
     fit_func->FixParameter(16, 0.153509);
     fit_func->FixParameter(19,242466);
     fit_func->FixParameter(20, 0.13959);
     ...
     life[m]=fit_func->GetParameter(1);
     dlife[m]=fit_func->GetParError(1);
     asym[m]=fit_func->GetParameter(2);
     dasym[m]=fit_func->GetParError(2);
     phi[m]=fit_func->GetParameter(4);
     dphi[m]=fit_func->GetParError(4);
     hcboN[m]=fit_func->GetParameter(5);
     dhcboN[m]=fit_func->GetParError(5);
     hcbolife[m]=fit_func->GetParameter(6);
     dhcbolife[m]=fit_func->GetParError(6);
     hcbofreq[m]=fit_func->GetParameter(7);
     dhcbofreq[m]=fit_func->GetParError(7);
     hcbophi[m]=fit_func->GetParameter(8);
     dhcbophi[m]=fit_func->GetParError(8);
     mloss[m]=fit_func->GetParameter(13);
     dmloss[m]=fit_func->GetParError(13);    
     //n[m]=m;
  ...
  c2->cd(3);
	...
	*/	
	cout<<"Calo "<<m<<endl;
    fit_func->SetParameters(1900000000/0.92, 64439.4, 0.234041, 0, 2.22, 0.00261778, 208510, 0.00234020, 3.57360);
     ...
     fit_func->SetParameter(14, -0.0014);
     fit_func->SetParameter(15, 45000);
     fit_func->SetParameter(16, 0.1535);
	...
	//	return;
     ...
     cout<<"Calo "<<m<<endl;
       fit_func->SetParameters(1899000000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 208510, 0.00234020, 3.57360);
     ...
     fit_func->SetParameter(14, -0.002);
     fit_func->SetParameter(15, 30000);
     fit_func->SetParameter(16, 0.1535);
     fit_func->SetParameter(17, 0);
     ...
     cout<<"Calo "<<m<<endl;
          fit_func->SetParameters(1948000000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     fit_func->SetParameter(14, -0.0026);
     fit_func->SetParameter(15, 20000);
     fit_func->SetParameter(16, 0.1535);
     fit_func->SetParameter(17, 2.33);
     ...
     cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1900000000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1930000000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 208510, 0.00234020, 3.57360);
     ...
     cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1930000000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 228510, 0.00234020, 3.57360);
     ...
     cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1936280000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     fit_func->SetParameter(14, -0.24);
     fit_func->SetParameter(15, 6565);
     fit_func->SetParameter(16, 0.1535);
     fit_func->SetParameter(17, -2.64);
     ...
     cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1930000000/1.13, 64439.4, 0.234041, 0, 2.22, 0.00261778, 200000, 0.002340, 0);
     ...
     m=m+1;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1930000000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     //  return;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1930000000/0.94, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     fit_func->SetParameter(14, -0.0026);
     fit_func->SetParameter(15, 70000);
     fit_func->SetParameter(16, 0.1535);
     fit_func->SetParameter(17, 0);
     ...
     m=m+1;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1930000000/1.02, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     //   return;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1930500000/0.99, 64439.4, 0.234041, 0, 2.22, 0.00261778, 228510, 0.00234020, 3.57360);
    ...
    n[m]=m;
     m=m+1;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1930000000/0.98, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
     ...
     //  return;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1930000000/1.01, 64439.4, 0.234041, 0, 2.22, 0.00261778, 218510, 0.00234020, 3.57360);
     ...
     //  return;
      ...
      cout<<"calo "<<m<<endl;
       fit_func->SetParameters(1996000000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 228510, 0.00234020, 3.57360);
     ...
     fit_func->SetParameter(14, -0.003);
     fit_func->SetParameter(15, 5200);
     fit_func->SetParameter(16, 0.1535);
     fit_func->SetParameter(17, 3.4);
     ...
     gr1=new TGraphErrors(m,n,chi15,0,0);
     ...
     gr1->Draw();
         ...
         c5=new TCanvas("c5","Blind R vs calo#");
     
       gr2=new TGraphErrors(m, n, mloss, 0, dmloss );
     gr2->SetTitle("muon loss amplitude vs calo#");
     gr2->GetXaxis()->SetTitle("calo #");
     gr2->GetYaxis()->SetTitle("mu_loss");
