...
char root_file_name[128] = "run2f_corr.root";
...
void run2f_dqc_18_par()
 ...
 // h_sum->Rebin(8);
   ...
   fit_func->SetParameters(12320000000/1.614, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57360);
   //, 0.002, 0.2);
   //, 1000000, 10000, 0.01, 0);
     ...
     //fit_func->FixParameter(13,0);
           ...
           h_sum->GetYaxis()->SetRangeUser(-100., 10000000000.);
