...
char root_file_name3[128] = "run2E_NE.root";
char root_file_name4[128] = "run2F_NE.root";
char root_file_name5[128] = "run2G_NE.root";
char root_file_name6[128] = "run2H_NE.root";
...
void run2_root_file_wo_2F_calo18()
{
  ...
  _file[6]=TFile::Open(root_file_name6);
    ...
    foutput=new TFile("run2_NE_no2FCalo18.root","new");
    for(int i=1;i<=24;i++)
    {
     hr1[i]->Write();
    }
