...
void chi2(Int_t &npar, Double_t *gin, Double_t &f, Double_t *par, Int_t inf)
{
 ...
 // h_sum->Rebin(8);
      ...
      //   h_sum->Rebin(8);
   fit_func1->SetParameters(22370600000, 64439.4, 0.234041, 0, 2.22, 0.00261778, 238510, 0.00234020, 3.57);
   //, 0.002, 0.2);
   //, 1000000, 10000, 0.01, 0);
   
     fit_func1->SetParameter(9,0.000485);
     fit_func1->SetParameter(10,0);
     fit_func1->SetParameter(11, -0.000311470);
     fit_func1->SetParameter(12,0);
     fit_func1->SetParameter(13,0);

     fit_func1->SetParameter(14, 0.00638136);
     fit_func1->SetParameter(15, 19300);
     fit_func1->SetParameter(16, 0.1535);
  ...
  //  h[1]->Rebin(4);
   ...
   hcomp= new TH1D("superposed histogram", "hcomp", hcalo->GetNbinsX(),  hcalo->GetBinLowEdge(1), (hcalo->GetBinLowEdge(hcalo->GetNbinsX())+hcalo->GetBinWidth(1)));
