...
void run3b_nbinshift_syst()
{
  ...
  for(Int_t i=1; i<=24; i++)
   ...
   cout<<h_sum->GetBinWidth(1)<<" "<<h_sum->GetNbinsX()<<" "<<h_sum->GetBinLowEdge(1)<<" "<<(h_sum->GetBinLowEdge(h_sum->GetNbinsX())+h_sum->GetBinWidth(1))<<" "<<endl;
	...
	nbinshift=nbinshift+1;
       ...
       fit_func23->SetParameter(0, 0.2294);
       fit_func23->SetParameter(1, 0.0);
       fit_func23->SetParameter(2, 2.2687);
       fit_func23->SetParameter(3, 0.002426);
       fit_func23->FixParameter(4, 209924);
       fit_func23->FixParameter(5, 0.00233115);
       ...
       fit_func23->FixParameter(12, 54672);
       fit_func23->FixParameter(13, 0.01390027);
       fit_func23->SetParameter(14, 0.273);
       fit_func23->SetParameter(15, -0.001);
       fit_func23->FixParameter(16, 21245);
       fit_func23->FixParameter(17, 0.014049);
       ...
       /*  if(fit_func23->GetParError(1)<0.5)
	 {
       ...
       */
       ...
       h_res[i]= new TH1D("3b residual histogram ", "h_res", hr[i]->GetNbinsX(), hr[i]->GetBinLowEdge(1), (hr[i]->GetBinLowEdge(hr[i]->GetNbinsX())+hr[i]->GetBinWidth(1)));
  ...
  c2 = new TCanvas("c2","3b per calo residuals");
  c2->Divide(10,5);
  c3 = new TCanvas("c3","3b per calo fft");
  c3->Divide(10,5);
 ...
 for(int i=1;i<=50;i++)
   {
    ...
    c1=new TCanvas("c1","3b Ratio blind R vs caloriemeter #");
    gr1=new TGraphErrors(m,n,dblindR,0,0);
    gr1->SetTitle("3b dR vs 15 time decimation bin-shift");
    ...
    c4=new TCanvas("c4","3b nominal fit parameters vs caloriemeter #");
    c4->Divide(1,3);
    c4->cd(1);
    gr2=new TGraphErrors(m,n,A,0,dA);
    gr2->SetTitle("3b Asymmetry vs 15 time decimation bin-shift");
    ...
    gr3->SetTitle("3b Blind R vs 15 time decimation bin-shift");
    ...
    gr4->SetTitle("3b phase vs 15 time decimation bin-shift");
    ...
    gr5->SetTitle("3b A_cbo vs 15 time decimation bin-shift");
    ...
    gr6->SetTitle("3b omega_cbo vs 15 time decimation bin-shift");
    ...
    gr7->SetTitle("3b Tau_cbo vs 15 time decimation bin-shift");
    ...
    gr8->SetTitle("3b phase_cbo vs 15 time decimation bin-shift");
    ...
    c5=new TCanvas("c5","3b cbo fit parameters vs caloriemeter #");
    c5->Divide(2,2);
    c5->cd(1);
    gr5->Draw();
    c5->cd(2);
    ...
    c6=new TCanvas("c6","3b vw fit parameters vs caloriemeter #");
    c6->Divide(2,2);
    c6->cd(1);
    gr9=new TGraphErrors(m,n,A_vw,0,dA_vw);
    gr9->SetTitle("3b A_vw vs 15 time decimation bin-shift");
    ...
    gr10->SetTitle("3b omega_vw vs 15 time decimation bin-shift");
    ...
    gr11->SetTitle("3b Tau_vw vs 15 time decimation bin-shift");
    ...
    gr12->SetTitle("3b phase_vw vs 15 time decimation bin-shift");
