...
void diff_nonlin_timate()
 ...
 TDirectoryFile *dir[25];
  ...
  //   cout<<"j ="<<j<<endl;
   ...
   for(Int_t k=42; k<=82;k++)
     {
       p1[m]=h_diff[1]->Integral((k*100),((k*100)+100))/hstat[1]->Integral();
	 n1[m]=k-41;
         if(k!=82){m=m+1;}
     }
   m=0;  
      for(Int_t k=42; k<=82;k++)
     {
	 p2[m]=h_diff[2]->Integral((k*100),((k*100)+100))/hstat[2]->Integral();
	 n2[m]=k-41;
         if(k!=82){m=m+1;}
     }
   ...
   for(Int_t k=42; k<=82;k++)
     {
	 p3[m]=h_diff[3]->Integral((k*100),((k*100)+100))/hstat[3]->Integral();
	 n3[m]=k-41;
         if(k!=82){m=m+1;}
     }
   m=0;
   ...
   for(Int_t k=42; k<=82;k++)
     {
	 p4[m]=h_diff[4]->Integral((k*100),((k*100)+100))/hstat[4]->Integral();
	 n4[m]=k-41;
         if(k!=82){m=m+1;}
     }
   ...
   for(Int_t k=42; k<=82;k++)
     {
	 p5[m]=h_diff[5]->Integral((k*100),((k*100)+100))/hstat[5]->Integral();
	 n5[m]=k-41;
         if(k!=82){m=m+1;}
     }
    ...
    gr1->SetTitle("normalized difference vs time-slice # ");
    gr1->GetXaxis()->SetTitle("time slice");
    gr1->GetYaxis()->SetTitle("Inetgral(odd-even)/no. of fills");
    gr1->SetLineWidth(7);
    gr1->SetMarkerStyle(20);
    gr1->SetLineColor(kBlue);
    gr1->Draw();
    //  gr1->GetYaxis()->SetRangeUser(-2100,-200);
    
        gr2=new TGraphErrors(m,n2,p2,0,0);
    gr2->SetTitle("normalized difference vs time-slice # ");
    gr2->GetXaxis()->SetTitle("time slice");
    gr2->GetYaxis()->SetTitle("Inetgral(odd-even)/no. of fills");
    gr2->SetLineWidth(7);
    gr2->SetMarkerStyle(20);
    gr2->SetLineColor(kBlack);
    gr2->Draw();
    
       gr3=new TGraphErrors(m,n3,p3,0,0);
    gr3->SetTitle("normalized difference vs time-slice # ");
    gr3->GetXaxis()->SetTitle("time slice");
    gr3->GetYaxis()->SetTitle("Inetgral(odd-even)/no. of fills");
    gr3->SetLineWidth(7);
    gr3->SetMarkerStyle(20);
    gr3->SetLineColor(kRed);
    gr3->Draw();
    
    gr4=new TGraphErrors(m,n4,p4,0,0);
    gr4->SetTitle("normalized difference vs time-slice # ");
    gr4->GetXaxis()->SetTitle("time slice");
    gr4->GetYaxis()->SetTitle("Inetgral(odd-even)/no. of fills");
    gr4->SetLineWidth(7);
    ...
    */
    ...
    gr5=new TGraphErrors(m,n5,p5,0,0);
    gr5->SetTitle("normalized difference vs time-slice # ");
    gr5->GetXaxis()->SetTitle("time slice");
    gr5->GetYaxis()->SetTitle("Inetgral(odd-even)/no. of fills");
    gr5->SetLineWidth(7);
