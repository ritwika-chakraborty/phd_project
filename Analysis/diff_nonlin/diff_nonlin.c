...
TH1D *qHist_1D[25], *h[25], *h_sum, *hcalo, *h_odd[25], *h_even[25], *h_diff[25], *h_average[25], *hstat;
//TH1 *hm;
...
//char root_file_name[128] = "run2c_1fill.root";
//char root_file_name[128] = "run2c_dqc_thresh_300.root";
char root_file_name[128] = "run2c_dqc_thresh_300.root";
//char root_file_name[128] = "run2c_dqc_24727_24739.root";
//char root_file_name[128] = "run2d_dqc_26013_100sr.root";
//char root_file_name[128] = "run2d_dqc_26013_subrun136.root";
//char root_file_name[128] = "run2c_1fill.root";

//char root_file_name[128] = "run2d_dqc_26013_1flush_xtals.root";
 ...
 cout<<sum<<" "<<endl;
  ...
  c1->Divide(4,6);
   ...
   for(Int_t j=1; j<=24; j++)
     ...
     // h_diff[j]->Scale(1/h_diff[j]->GetEntries());
      c1->cd(j);
      //  h_diff[j]->Fit("pol1","R","",150000, 350000);
       n[m]=j;
       //TF1 *myfit = (TF1*) h_diff[j]->GetFunction("pol1");
       p0[m]=h_diff[j]->Integral(6667,8334)/(54*1668*hstat->Integral());
   ...
   c2=new TCanvas("c2","odd even difference parameter");   
    ...
    gr1->SetTitle("Amplitude vs calo");
